...
{
public:
	class USMStateMachineInstance*                ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	class USMInstance*                            ReturnValue;                                       // 0x0008(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
// Function SMSystem.SMStateInstance_Base.SetAnimGroupTag
// 0x0008 (0x0008 - 0x0000)
struct SMStateInstance_Base_SetAnimGroupTag final
{
public:
	struct FGameplayTag                           Value;                                             // 0x0000(0x0008)(ConstParm, Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMStateInstance_Base_SetAnimGroupTag) == 0x000004, "Wrong alignment on SMStateInstance_Base_SetAnimGroupTag");
static_assert(sizeof(SMStateInstance_Base_SetAnimGroupTag) == 0x000008, "Wrong size on SMStateInstance_Base_SetAnimGroupTag");
static_assert(offsetof(SMStateInstance_Base_SetAnimGroupTag, Value) == 0x000000, "Member 'SMStateInstance_Base_SetAnimGroupTag::Value' has a wrong offset!");
...
// Function SMSystem.SMStateInstance_Base.SetStanceTagGroup
// 0x0010 (0x0010 - 0x0000)
struct SMStateInstance_Base_SetStanceTagGroup final
{
public:
	TArray<struct FGameplayTag>                   StanceTagGroup_0;                                  // 0x0000(0x0010)(ConstParm, Parm, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMStateInstance_Base_SetStanceTagGroup) == 0x000008, "Wrong alignment on SMStateInstance_Base_SetStanceTagGroup");
static_assert(sizeof(SMStateInstance_Base_SetStanceTagGroup) == 0x000010, "Wrong size on SMStateInstance_Base_SetStanceTagGroup");
static_assert(offsetof(SMStateInstance_Base_SetStanceTagGroup, StanceTagGroup_0) == 0x000000, "Member 'SMStateInstance_Base_SetStanceTagGroup::StanceTagGroup_0' has a wrong offset!");
...
{
public:
	class USMStateInstance_Base*                  NextStateInstance;                                 // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class USMTransitionInstance*                  TransitionInstance;                                // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRequireTransitionToPass;                          // 0x0008(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bActivateNow;                                      // 0x0009(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x000A(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B[0x5];                                        // 0x000B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// Function SMSystem.SMStateInstance_Base.GetAnimGroupTag
// 0x0008 (0x0008 - 0x0000)
struct SMStateInstance_Base_GetAnimGroupTag final
{
public:
...
static_assert(alignof(SMStateInstance_Base_GetAnimGroupTag) == 0x000004, "Wrong alignment on SMStateInstance_Base_GetAnimGroupTag");
static_assert(sizeof(SMStateInstance_Base_GetAnimGroupTag) == 0x000008, "Wrong size on SMStateInstance_Base_GetAnimGroupTag");
static_assert(offsetof(SMStateInstance_Base_GetAnimGroupTag, ReturnValue) == 0x000000, "Member 'SMStateInstance_Base_GetAnimGroupTag::ReturnValue' has a wrong offset!");
...
public:
	...
	class USMStateInstance_Base*                  ReturnValue;                                       // 0x0008(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class USMStateInstance_Base*                  ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class USMTransitionInstance*                  ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
// Function SMSystem.SMStateInstance_Base.GetStanceTagGroup
// 0x0010 (0x0010 - 0x0000)
struct SMStateInstance_Base_GetStanceTagGroup final
{
public:
	TArray<struct FGameplayTag>                   ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMStateInstance_Base_GetStanceTagGroup) == 0x000008, "Wrong alignment on SMStateInstance_Base_GetStanceTagGroup");
static_assert(sizeof(SMStateInstance_Base_GetStanceTagGroup) == 0x000010, "Wrong size on SMStateInstance_Base_GetStanceTagGroup");
static_assert(offsetof(SMStateInstance_Base_GetStanceTagGroup, ReturnValue) == 0x000000, "Member 'SMStateInstance_Base_GetStanceTagGroup::ReturnValue' has a wrong offset!");
...
public:
	int32                                         Index_0;                                           // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class USMTransitionInstance*                  ReturnValue;                                       // 0x0008(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class USMTransitionInstance*                  InFirstTransitionInstance;                         // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class USMStateInstance_Base*                  OutDestinationState;                               // 0x0018(0x0008)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class USMInstance*                            ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TSubclassOf<class USMStateMachineInstance>    NewStateMachineClass;                              // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class USMStateInstance_Base*                  NewStateInstance;                                  // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class USMStateMachineComponent*               ReturnValue;                                       // 0x0000(0x0008)(ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
// Function SMSystem.SMInstance.GetExportDataTable
// 0x0008 (0x0008 - 0x0000)
struct SMInstance_GetExportDataTable final
{
public:
...
static_assert(alignof(SMInstance_GetExportDataTable) == 0x000008, "Wrong alignment on SMInstance_GetExportDataTable");
static_assert(sizeof(SMInstance_GetExportDataTable) == 0x000008, "Wrong size on SMInstance_GetExportDataTable");
static_assert(offsetof(SMInstance_GetExportDataTable, ReturnValue) == 0x000000, "Member 'SMInstance_GetExportDataTable::ReturnValue' has a wrong offset!");
...
public:
	...
	class USMNodeInstance*                        ReturnValue;                                       // 0x0010(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	struct FGuid                                  Guid;                                              // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USMInstance*                            ReturnValue;                                       // 0x0010(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TSubclassOf<class USMStateMachineInstance>    ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	struct FGuid                                  Guid;                                              // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USMTransitionInstance*                  ReturnValue;                                       // 0x0010(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class USMStateMachineComponent*               OtherComponent;                                    // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class USMInstance*                            Instance;                                          // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(alignof(SMStateMachineComponent_Internal_OnStateMachineShutdown) == 0x000008, "Wrong alignment on SMStateMachineComponent_Internal_OnStateMachineShutdown");
static_assert(sizeof(SMStateMachineComponent_Internal_OnStateMachineShutdown) == 0x000008, "Wrong size on SMStateMachineComponent_Internal_OnStateMachineShutdown");
static_assert(offsetof(SMStateMachineComponent_Internal_OnStateMachineShutdown, Instance) == 0x000000, "Member 'SMStateMachineComponent_Internal_OnStateMachineShutdown::Instance' has a wrong offset!");
...
public:
	...
	class AController*                            NewController;                                     // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMStateMachineComponent_OnContextPawnControllerChanged) == 0x000008, "Wrong alignment on SMStateMachineComponent_OnContextPawnControllerChanged");
static_assert(sizeof(SMStateMachineComponent_OnContextPawnControllerChanged) == 0x000010, "Wrong size on SMStateMachineComponent_OnContextPawnControllerChanged");
static_assert(offsetof(SMStateMachineComponent_OnContextPawnControllerChanged, Pawn) == 0x000000, "Member 'SMStateMachineComponent_OnContextPawnControllerChanged::Pawn' has a wrong offset!");
static_assert(offsetof(SMStateMachineComponent_OnContextPawnControllerChanged, NewController) == 0x000008, "Member 'SMStateMachineComponent_OnContextPawnControllerChanged::NewController' has a wrong offset!");
...
static_assert(alignof(SMStateMachineComponent_SERVER_RequestFullSync) == 0x000001, "Wrong alignment on SMStateMachineComponent_SERVER_RequestFullSync");
...
static_assert(offsetof(SMStateMachineComponent_SERVER_RequestFullSync, bForceFullRefresh) == 0x000000, "Member 'SMStateMachineComponent_SERVER_RequestFullSync::bForceFullRefresh' has a wrong offset!");
...
static_assert(alignof(SMTransitionInstance_EvaluateFromManuallyBoundEvent) == 0x000001, "Wrong alignment on SMTransitionInstance_EvaluateFromManuallyBoundEvent");
static_assert(sizeof(SMTransitionInstance_EvaluateFromManuallyBoundEvent) == 0x000001, "Wrong size on SMTransitionInstance_EvaluateFromManuallyBoundEvent");
static_assert(offsetof(SMTransitionInstance_EvaluateFromManuallyBoundEvent, ReturnValue) == 0x000000, "Member 'SMTransitionInstance_EvaluateFromManuallyBoundEvent::ReturnValue' has a wrong offset!");

// Function SMSystem.SMTransitionInstance.SetBlendSetting
// 0x0020 (0x0020 - 0x0000)
struct SMTransitionInstance_SetBlendSetting final
{
public:
	struct FSMBlendSetting                        Value;                                             // 0x0000(0x0020)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMTransitionInstance_SetBlendSetting) == 0x000008, "Wrong alignment on SMTransitionInstance_SetBlendSetting");
static_assert(sizeof(SMTransitionInstance_SetBlendSetting) == 0x000020, "Wrong size on SMTransitionInstance_SetBlendSetting");
static_assert(offsetof(SMTransitionInstance_SetBlendSetting, Value) == 0x000000, "Member 'SMTransitionInstance_SetBlendSetting::Value' has a wrong offset!");
...
// Function SMSystem.SMTransitionInstance.SetFastTransitionFlag
// 0x0001 (0x0001 - 0x0000)
struct SMTransitionInstance_SetFastTransitionFlag final
{
public:
	bool                                          bValue;                                            // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMTransitionInstance_SetFastTransitionFlag) == 0x000001, "Wrong alignment on SMTransitionInstance_SetFastTransitionFlag");
static_assert(sizeof(SMTransitionInstance_SetFastTransitionFlag) == 0x000001, "Wrong size on SMTransitionInstance_SetFastTransitionFlag");
static_assert(offsetof(SMTransitionInstance_SetFastTransitionFlag, bValue) == 0x000000, "Member 'SMTransitionInstance_SetFastTransitionFlag::bValue' has a wrong offset!");

// Function SMSystem.SMTransitionInstance.SetLinkSequenceTag
// 0x0008 (0x0008 - 0x0000)
struct SMTransitionInstance_SetLinkSequenceTag final
{
public:
...
static_assert(alignof(SMTransitionInstance_SetLinkSequenceTag) == 0x000004, "Wrong alignment on SMTransitionInstance_SetLinkSequenceTag");
static_assert(sizeof(SMTransitionInstance_SetLinkSequenceTag) == 0x000008, "Wrong size on SMTransitionInstance_SetLinkSequenceTag");
static_assert(offsetof(SMTransitionInstance_SetLinkSequenceTag, Value) == 0x000000, "Member 'SMTransitionInstance_SetLinkSequenceTag::Value' has a wrong offset!");
...
// Function SMSystem.SMTransitionInstance.GetBlendSetting
// 0x0020 (0x0020 - 0x0000)
struct SMTransitionInstance_GetBlendSetting final
{
public:
	struct FSMBlendSetting                        ReturnValue;                                       // 0x0000(0x0020)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMTransitionInstance_GetBlendSetting) == 0x000008, "Wrong alignment on SMTransitionInstance_GetBlendSetting");
static_assert(sizeof(SMTransitionInstance_GetBlendSetting) == 0x000020, "Wrong size on SMTransitionInstance_GetBlendSetting");
static_assert(offsetof(SMTransitionInstance_GetBlendSetting, ReturnValue) == 0x000000, "Member 'SMTransitionInstance_GetBlendSetting::ReturnValue' has a wrong offset!");
...
// Function SMSystem.SMTransitionInstance.GetFastBlendSetting
// 0x0020 (0x0020 - 0x0000)
struct SMTransitionInstance_GetFastBlendSetting final
{
public:
	struct FSMBlendSetting                        ReturnValue;                                       // 0x0000(0x0020)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMTransitionInstance_GetFastBlendSetting) == 0x000008, "Wrong alignment on SMTransitionInstance_GetFastBlendSetting");
static_assert(sizeof(SMTransitionInstance_GetFastBlendSetting) == 0x000020, "Wrong size on SMTransitionInstance_GetFastBlendSetting");
static_assert(offsetof(SMTransitionInstance_GetFastBlendSetting, ReturnValue) == 0x000000, "Member 'SMTransitionInstance_GetFastBlendSetting::ReturnValue' has a wrong offset!");

// Function SMSystem.SMTransitionInstance.GetFastLinkSequenceTag
// 0x0008 (0x0008 - 0x0000)
struct SMTransitionInstance_GetFastLinkSequenceTag final
{
public:
	struct FGameplayTag                           ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMTransitionInstance_GetFastLinkSequenceTag) == 0x000004, "Wrong alignment on SMTransitionInstance_GetFastLinkSequenceTag");
static_assert(sizeof(SMTransitionInstance_GetFastLinkSequenceTag) == 0x000008, "Wrong size on SMTransitionInstance_GetFastLinkSequenceTag");
static_assert(offsetof(SMTransitionInstance_GetFastLinkSequenceTag, ReturnValue) == 0x000000, "Member 'SMTransitionInstance_GetFastLinkSequenceTag::ReturnValue' has a wrong offset!");

// Function SMSystem.SMTransitionInstance.GetFastTransitionFlag
// 0x0001 (0x0001 - 0x0000)
struct SMTransitionInstance_GetFastTransitionFlag final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMTransitionInstance_GetFastTransitionFlag) == 0x000001, "Wrong alignment on SMTransitionInstance_GetFastTransitionFlag");
static_assert(sizeof(SMTransitionInstance_GetFastTransitionFlag) == 0x000001, "Wrong size on SMTransitionInstance_GetFastTransitionFlag");
static_assert(offsetof(SMTransitionInstance_GetFastTransitionFlag, ReturnValue) == 0x000000, "Member 'SMTransitionInstance_GetFastTransitionFlag::ReturnValue' has a wrong offset!");

// Function SMSystem.SMTransitionInstance.GetLinkSequenceTag
// 0x0008 (0x0008 - 0x0000)
struct SMTransitionInstance_GetLinkSequenceTag final
{
public:
	struct FGameplayTag                           ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SMTransitionInstance_GetLinkSequenceTag) == 0x000004, "Wrong alignment on SMTransitionInstance_GetLinkSequenceTag");
static_assert(sizeof(SMTransitionInstance_GetLinkSequenceTag) == 0x000008, "Wrong size on SMTransitionInstance_GetLinkSequenceTag");
static_assert(offsetof(SMTransitionInstance_GetLinkSequenceTag, ReturnValue) == 0x000000, "Member 'SMTransitionInstance_GetLinkSequenceTag::ReturnValue' has a wrong offset!");
...
static_assert(alignof(SMTransitionInstance_IsTransitionFromLinkState) == 0x000001, "Wrong alignment on SMTransitionInstance_IsTransitionFromLinkState");
static_assert(sizeof(SMTransitionInstance_IsTransitionFromLinkState) == 0x000001, "Wrong size on SMTransitionInstance_IsTransitionFromLinkState");
static_assert(offsetof(SMTransitionInstance_IsTransitionFromLinkState, ReturnValue) == 0x000000, "Member 'SMTransitionInstance_IsTransitionFromLinkState::ReturnValue' has a wrong offset!");
...
{
public:
	TSubclassOf<class USMInstance>                StateMachineClass;                                 // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                Context;                                           // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USMInstance*                            Template;                                          // 0x0010(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class USMInstance*                            ReturnValue;                                       // 0x0020(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
// Function SMSystem.SMBlueprintUtils.K2_CreateStateMachineInstanceFromObject
// 0x0020 (0x0020 - 0x0000)
struct SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject final
{
public:
...
static_assert(alignof(SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject) == 0x000008, "Wrong alignment on SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject");
static_assert(sizeof(SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject) == 0x000020, "Wrong size on SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject");
static_assert(offsetof(SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject, InObj) == 0x000000, "Member 'SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject::InObj' has a wrong offset!");
static_assert(offsetof(SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject, Context) == 0x000008, "Member 'SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject::Context' has a wrong offset!");
static_assert(offsetof(SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject, bInitializeNow) == 0x000010, "Member 'SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject::bInitializeNow' has a wrong offset!");
static_assert(offsetof(SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject, ReturnValue) == 0x000018, "Member 'SMBlueprintUtils_K2_CreateStateMachineInstanceFromObject::ReturnValue' has a wrong offset!");
