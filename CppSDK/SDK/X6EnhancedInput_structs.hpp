...
public:
	...
	bool                                          bExclusive;                                        // 0x0040(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FX6EnhancedActionKeyMapping) == 0x000008, "Wrong alignment on FX6EnhancedActionKeyMapping");
static_assert(sizeof(FX6EnhancedActionKeyMapping) == 0x000048, "Wrong size on FX6EnhancedActionKeyMapping");
...
static_assert(offsetof(FX6EnhancedActionKeyMapping, bExclusive) == 0x000040, "Member 'FX6EnhancedActionKeyMapping::bExclusive' has a wrong offset!");
