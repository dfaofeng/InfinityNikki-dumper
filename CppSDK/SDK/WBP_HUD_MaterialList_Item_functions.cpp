...
#include "WBP_HUD_MaterialList_Item_classes.hpp"
#include "WBP_HUD_MaterialList_Item_parameters.hpp"
...
void UWBP_HUD_MaterialList_Item_C::BP_OnItemSelectionChanged(bool bIsSelected)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_HUD_MaterialList_Item_C", "BP_OnItemSelectionChanged");

	Params::WBP_HUD_MaterialList_Item_C_BP_OnItemSelectionChanged Parms{};
...
class FString UWBP_HUD_MaterialList_Item_C::GetModuleName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_HUD_MaterialList_Item_C", "GetModuleName");

	Params::WBP_HUD_MaterialList_Item_C_GetModuleName Parms{};
