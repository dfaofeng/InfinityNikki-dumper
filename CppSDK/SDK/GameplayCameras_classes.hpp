...
{
public:
	class USceneComponent*                        SceneComponent;                                    // 0x03A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UGameplayCameraComponent*               CameraComponent;                                   // 0x03B0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AGameplayCameraActor) == 0x0003B8, "Wrong size on AGameplayCameraActor");
static_assert(offsetof(AGameplayCameraActor, SceneComponent) == 0x0003A8, "Member 'AGameplayCameraActor::SceneComponent' has a wrong offset!");
static_assert(offsetof(AGameplayCameraActor, CameraComponent) == 0x0003B0, "Member 'AGameplayCameraActor::CameraComponent' has a wrong offset!");
...
{
public:
	class UGameplayCameraSystemComponent*         CameraSystemComponent;                             // 0x03A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EAutoReceiveInput                             AutoActivateForPlayer;                             // 0x03B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AGameplayCameraSystemActor) == 0x0003B8, "Wrong size on AGameplayCameraSystemActor");
static_assert(offsetof(AGameplayCameraSystemActor, CameraSystemComponent) == 0x0003A8, "Member 'AGameplayCameraSystemActor::CameraSystemComponent' has a wrong offset!");
static_assert(offsetof(AGameplayCameraSystemActor, AutoActivateForPlayer) == 0x0003B0, "Member 'AGameplayCameraSystemActor::AutoActivateForPlayer' has a wrong offset!");
