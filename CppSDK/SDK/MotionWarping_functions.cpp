...
struct FTransform UMotionWarpingUtilities::ExtractRootMotionFromAnimation(const class UAnimSequenceBase* Animation, float StartTime, float EndTime, bool bMirror)
{
	static class UFunction* Func = nullptr;
...
// class URootMotionModifier_AdjustmentBlendWarp*ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
