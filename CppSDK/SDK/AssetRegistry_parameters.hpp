...
// 0x0001 (0x0001 - 0x0000)
struct AssetRegistry_WaitForCompletion final
{
public:
	bool                                          bSkipBroadcast;                                    // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AssetRegistry_WaitForCompletion) == 0x000001, "Wrong alignment on AssetRegistry_WaitForCompletion");
static_assert(sizeof(AssetRegistry_WaitForCompletion) == 0x000001, "Wrong size on AssetRegistry_WaitForCompletion");
static_assert(offsetof(AssetRegistry_WaitForCompletion, bSkipBroadcast) == 0x000000, "Member 'AssetRegistry_WaitForCompletion::bSkipBroadcast' has a wrong offset!");
