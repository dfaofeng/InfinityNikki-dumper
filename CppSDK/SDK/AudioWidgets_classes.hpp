...
// 0x0588 (0x0710 - 0x0188)
class UAudioMeter final : public UWidget
{
public:
	TArray<struct FMeterChannelInfo>              MeterChannelInfo;                                  // 0x0188(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TDelegate<void()>                             MeterChannelInfoDelegate;                          // 0x0198(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A8[0x8];                                      // 0x01A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAudioMeterStyle                       WidgetStyle;                                       // 0x01B0(0x04D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAudioMeter) == 0x000710, "Wrong size on UAudioMeter");
static_assert(offsetof(UAudioMeter, MeterChannelInfo) == 0x000188, "Member 'UAudioMeter::MeterChannelInfo' has a wrong offset!");
static_assert(offsetof(UAudioMeter, MeterChannelInfoDelegate) == 0x000198, "Member 'UAudioMeter::MeterChannelInfoDelegate' has a wrong offset!");
static_assert(offsetof(UAudioMeter, WidgetStyle) == 0x0001B0, "Member 'UAudioMeter::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UAudioMeter, Orientation) == 0x000680, "Member 'UAudioMeter::Orientation' has a wrong offset!");
static_assert(offsetof(UAudioMeter, BackgroundColor) == 0x000684, "Member 'UAudioMeter::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UAudioMeter, MeterBackgroundColor) == 0x000694, "Member 'UAudioMeter::MeterBackgroundColor' has a wrong offset!");
static_assert(offsetof(UAudioMeter, MeterValueColor) == 0x0006A4, "Member 'UAudioMeter::MeterValueColor' has a wrong offset!");
static_assert(offsetof(UAudioMeter, MeterPeakColor) == 0x0006B4, "Member 'UAudioMeter::MeterPeakColor' has a wrong offset!");
static_assert(offsetof(UAudioMeter, MeterClippingColor) == 0x0006C4, "Member 'UAudioMeter::MeterClippingColor' has a wrong offset!");
static_assert(offsetof(UAudioMeter, MeterScaleColor) == 0x0006D4, "Member 'UAudioMeter::MeterScaleColor' has a wrong offset!");
static_assert(offsetof(UAudioMeter, MeterScaleLabelColor) == 0x0006E4, "Member 'UAudioMeter::MeterScaleLabelColor' has a wrong offset!");

// Class AudioWidgets.AudioOscilloscope
// 0x0518 (0x06A0 - 0x0188)
class UAudioOscilloscope final : public UWidget
{
public:
	uint8                                         Pad_188[0x8];                                      // 0x0188(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAudioOscilloscopePanelStyle           OscilloscopeStyle;                                 // 0x0190(0x04A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UAudioBus*                              AudioBus;                                          // 0x0630(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TimeWindowMs;                                      // 0x0638(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AnalysisPeriodMs;                                  // 0x063C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowTimeGrid;                                     // 0x0640(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EXAxisLabelsUnit                              TimeGridLabelsUnit;                                // 0x0641(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowAmplitudeGrid;                                // 0x0642(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowAmplitudeLabels;                              // 0x0643(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EYAxisLabelsUnit                              AmplitudeGridLabelsUnit;                           // 0x0644(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowTriggerThresholdLine;                         // 0x0645(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_646[0x2];                                      // 0x0646(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TriggerThreshold;                                  // 0x0648(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAudioPanelLayoutType                         PanelLayoutType;                                   // 0x064C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64D[0x53];                                     // 0x064D(0x0053)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAudioOscilloscope) == 0x0006A0, "Wrong size on UAudioOscilloscope");
static_assert(offsetof(UAudioOscilloscope, OscilloscopeStyle) == 0x000190, "Member 'UAudioOscilloscope::OscilloscopeStyle' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, AudioBus) == 0x000630, "Member 'UAudioOscilloscope::AudioBus' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, TimeWindowMs) == 0x000638, "Member 'UAudioOscilloscope::TimeWindowMs' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, AnalysisPeriodMs) == 0x00063C, "Member 'UAudioOscilloscope::AnalysisPeriodMs' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, bShowTimeGrid) == 0x000640, "Member 'UAudioOscilloscope::bShowTimeGrid' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, TimeGridLabelsUnit) == 0x000641, "Member 'UAudioOscilloscope::TimeGridLabelsUnit' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, bShowAmplitudeGrid) == 0x000642, "Member 'UAudioOscilloscope::bShowAmplitudeGrid' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, bShowAmplitudeLabels) == 0x000643, "Member 'UAudioOscilloscope::bShowAmplitudeLabels' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, AmplitudeGridLabelsUnit) == 0x000644, "Member 'UAudioOscilloscope::AmplitudeGridLabelsUnit' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, bShowTriggerThresholdLine) == 0x000645, "Member 'UAudioOscilloscope::bShowTriggerThresholdLine' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, TriggerThreshold) == 0x000648, "Member 'UAudioOscilloscope::TriggerThreshold' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, PanelLayoutType) == 0x00064C, "Member 'UAudioOscilloscope::PanelLayoutType' has a wrong offset!");
...
public:
	...
	EAudioRadialSliderLayout                      WidgetLayout;                                      // 0x019C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19D[0x3];                                      // 0x019D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           CenterBackgroundColor;                             // 0x01A0(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           SliderProgressColor;                               // 0x01B0(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FVector2D                              HandStartEndRatio;                                 // 0x01D0(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   UnitsText;                                         // 0x01E0(0x0010)(Edit, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAudioRadialSlider, Value) == 0x000188, "Member 'UAudioRadialSlider::Value' has a wrong offset!");
static_assert(offsetof(UAudioRadialSlider, ValueDelegate) == 0x00018C, "Member 'UAudioRadialSlider::ValueDelegate' has a wrong offset!");
static_assert(offsetof(UAudioRadialSlider, WidgetLayout) == 0x00019C, "Member 'UAudioRadialSlider::WidgetLayout' has a wrong offset!");
static_assert(offsetof(UAudioRadialSlider, CenterBackgroundColor) == 0x0001A0, "Member 'UAudioRadialSlider::CenterBackgroundColor' has a wrong offset!");
static_assert(offsetof(UAudioRadialSlider, SliderProgressColor) == 0x0001B0, "Member 'UAudioRadialSlider::SliderProgressColor' has a wrong offset!");
static_assert(offsetof(UAudioRadialSlider, SliderBarColor) == 0x0001C0, "Member 'UAudioRadialSlider::SliderBarColor' has a wrong offset!");
static_assert(offsetof(UAudioRadialSlider, HandStartEndRatio) == 0x0001D0, "Member 'UAudioRadialSlider::HandStartEndRatio' has a wrong offset!");
static_assert(offsetof(UAudioRadialSlider, UnitsText) == 0x0001E0, "Member 'UAudioRadialSlider::UnitsText' has a wrong offset!");
...
// 0x0848 (0x09D0 - 0x0188)
class alignas(0x10) UAudioSliderBase : public UWidget
{
public:
	float                                         Value;                                             // 0x0188(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_18C[0x4];                                      // 0x018C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   UnitsText;                                         // 0x0190(0x0010)(Edit, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAudioSliderBase, Value) == 0x000188, "Member 'UAudioSliderBase::Value' has a wrong offset!");
static_assert(offsetof(UAudioSliderBase, UnitsText) == 0x000190, "Member 'UAudioSliderBase::UnitsText' has a wrong offset!");
...
public:
	uint8                                         Pad_188[0x8];                                      // 0x0188(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAudioVectorscopePanelStyle            VectorscopeStyle;                                  // 0x0190(0x01C0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UAudioBus*                              AudioBus;                                          // 0x0350(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowGrid;                                         // 0x0358(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_359[0x3];                                      // 0x0359(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         GridDivisions;                                     // 0x035C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DisplayPersistenceMs;                              // 0x0360(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Scale;                                             // 0x0364(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAudioPanelLayoutType                         PanelLayoutType;                                   // 0x0368(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAudioVectorscope) == 0x0003C0, "Wrong size on UAudioVectorscope");
static_assert(offsetof(UAudioVectorscope, VectorscopeStyle) == 0x000190, "Member 'UAudioVectorscope::VectorscopeStyle' has a wrong offset!");
static_assert(offsetof(UAudioVectorscope, AudioBus) == 0x000350, "Member 'UAudioVectorscope::AudioBus' has a wrong offset!");
static_assert(offsetof(UAudioVectorscope, bShowGrid) == 0x000358, "Member 'UAudioVectorscope::bShowGrid' has a wrong offset!");
static_assert(offsetof(UAudioVectorscope, GridDivisions) == 0x00035C, "Member 'UAudioVectorscope::GridDivisions' has a wrong offset!");
static_assert(offsetof(UAudioVectorscope, DisplayPersistenceMs) == 0x000360, "Member 'UAudioVectorscope::DisplayPersistenceMs' has a wrong offset!");
static_assert(offsetof(UAudioVectorscope, Scale) == 0x000364, "Member 'UAudioVectorscope::Scale' has a wrong offset!");
static_assert(offsetof(UAudioVectorscope, PanelLayoutType) == 0x000368, "Member 'UAudioVectorscope::PanelLayoutType' has a wrong offset!");
