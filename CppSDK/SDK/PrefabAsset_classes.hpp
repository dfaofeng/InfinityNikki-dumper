...
static_assert(sizeof(UPrefabAsset) == 0x0000E8, "Wrong size on UPrefabAsset");
...
{
public:
	class UPrefabAsset*                           Parent;                                            // 0x00E8(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPrefabVariantAsset) == 0x0000F0, "Wrong size on UPrefabVariantAsset");
static_assert(offsetof(UPrefabVariantAsset, Parent) == 0x0000E8, "Member 'UPrefabVariantAsset::Parent' has a wrong offset!");
...
{
public:
	static class AX6PrefabActor* SpawnPrefab(const class UObject* WorldContextObject, class UPrefabAsset* PrefabAsset, const struct FTransform& SpawnTransform, TArray<class AActor*>* OutSpawnPrefabInstances, bool bSpawnInstancesOnly, ESpawnActorCollisionHandlingMethod CollisionHandlingOverride, class AActor* Owner);
...
static_assert(sizeof(UPrefabToolSettings) == 0x000120, "Wrong size on UPrefabToolSettings");
...
// Class PrefabAsset.X6PrefabActor
// 0x0008 (0x03B0 - 0x03A8)
class AX6PrefabActor final : public AActor
{
public:
	class UX6PrefabComponent*                     PrefabComponent;                                   // 0x03A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"X6PrefabActor">();
	}
	static class AX6PrefabActor* GetDefaultObj()
	{
		return GetDefaultObjImpl<AX6PrefabActor>();
	}
};
static_assert(alignof(AX6PrefabActor) == 0x000008, "Wrong alignment on AX6PrefabActor");
static_assert(sizeof(AX6PrefabActor) == 0x0003B0, "Wrong size on AX6PrefabActor");
static_assert(offsetof(AX6PrefabActor, PrefabComponent) == 0x0003A8, "Member 'AX6PrefabActor::PrefabComponent' has a wrong offset!");

// Class PrefabAsset.X6PrefabComponent
// 0x0080 (0x0640 - 0x05C0)
class UX6PrefabComponent final : public UPrimitiveComponent
{
public:
	uint8                                         bConnected : 1;                                    // 0x05B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bLockSelection : 1;                                // 0x05B8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_5B9[0x7];                                      // 0x05B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrefabAsset*                           Prefab;                                            // 0x05C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UBlueprint*                             GeneratedBlueprint;                                // 0x05C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, class AActor*>              PrefabInstancesMap;                                // 0x05D0(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnTemplate, EditConst, AdvancedDisplay, NativeAccessSpecifierPublic)
	TArray<struct FPrefabVariantRule>             VariantRulesOverwrite;                             // 0x0620(0x0010)(Edit, BlueprintVisible, ZeroConstructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	uint8                                         bTransient : 1;                                    // 0x0630(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnTemplate, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_631[0xF];                                      // 0x0631(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"X6PrefabComponent">();
	}
	static class UX6PrefabComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UX6PrefabComponent>();
	}
};
static_assert(alignof(UX6PrefabComponent) == 0x000010, "Wrong alignment on UX6PrefabComponent");
static_assert(sizeof(UX6PrefabComponent) == 0x000640, "Wrong size on UX6PrefabComponent");
static_assert(offsetof(UX6PrefabComponent, Prefab) == 0x0005C0, "Member 'UX6PrefabComponent::Prefab' has a wrong offset!");
static_assert(offsetof(UX6PrefabComponent, GeneratedBlueprint) == 0x0005C8, "Member 'UX6PrefabComponent::GeneratedBlueprint' has a wrong offset!");
static_assert(offsetof(UX6PrefabComponent, PrefabInstancesMap) == 0x0005D0, "Member 'UX6PrefabComponent::PrefabInstancesMap' has a wrong offset!");
static_assert(offsetof(UX6PrefabComponent, VariantRulesOverwrite) == 0x000620, "Member 'UX6PrefabComponent::VariantRulesOverwrite' has a wrong offset!");
