...
enum class EMovieSceneSequenceFlags : uint8
{
	...
	VolatileAndBlockingEvaluation            = 3,
	DynamicWeighting                         = 4,
	InheritedFlags                           = 1,
...
// Enum MovieScene.EMovieSceneNetPolicy
// NumValues: 0x0004
enum class EMovieSceneNetPolicy : uint8
{
	AuthorityOnly                            = 0,
	SimulatedOnly                            = 1,
	All                                      = 2,
	EMovieSceneNetPolicy_MAX                 = 3,
};
...
public:
	...
	uint8                                         bIsInSoloLevel : 1;                                // 0x0024(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	...
	uint8                                         bEvalNearestPreviouSection : 1;                    // 0x0000(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
