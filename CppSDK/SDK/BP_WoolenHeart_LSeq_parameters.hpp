...
{
public:
	struct FF_GetWoolenHeartPerformanceInfo       PerformanceInfo_0;                                 // 0x0000(0x0128)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_WoolenHeart_LSeq_C_SetPerformacneInfo) == 0x000128, "Wrong size on BP_WoolenHeart_LSeq_C_SetPerformacneInfo");
