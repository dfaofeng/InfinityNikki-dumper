...
// Function AIModule.BlackboardComponent.SetValueAsInt64
// 0x0010 (0x0010 - 0x0000)
struct BlackboardComponent_SetValueAsInt64 final
{
public:
	class FName                                   KeyName;                                           // 0x0000(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int64                                         IntValue;                                          // 0x0008(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(BlackboardComponent_SetValueAsInt64) == 0x000008, "Wrong alignment on BlackboardComponent_SetValueAsInt64");
static_assert(sizeof(BlackboardComponent_SetValueAsInt64) == 0x000010, "Wrong size on BlackboardComponent_SetValueAsInt64");
static_assert(offsetof(BlackboardComponent_SetValueAsInt64, KeyName) == 0x000000, "Member 'BlackboardComponent_SetValueAsInt64::KeyName' has a wrong offset!");
static_assert(offsetof(BlackboardComponent_SetValueAsInt64, IntValue) == 0x000008, "Member 'BlackboardComponent_SetValueAsInt64::IntValue' has a wrong offset!");
...
// Function AIModule.BlackboardComponent.GetValueAsInt64
// 0x0010 (0x0010 - 0x0000)
struct BlackboardComponent_GetValueAsInt64 final
{
public:
	class FName                                   KeyName;                                           // 0x0000(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(BlackboardComponent_GetValueAsInt64) == 0x000008, "Wrong alignment on BlackboardComponent_GetValueAsInt64");
static_assert(sizeof(BlackboardComponent_GetValueAsInt64) == 0x000010, "Wrong size on BlackboardComponent_GetValueAsInt64");
static_assert(offsetof(BlackboardComponent_GetValueAsInt64, KeyName) == 0x000000, "Member 'BlackboardComponent_GetValueAsInt64::KeyName' has a wrong offset!");
static_assert(offsetof(BlackboardComponent_GetValueAsInt64, ReturnValue) == 0x000008, "Member 'BlackboardComponent_GetValueAsInt64::ReturnValue' has a wrong offset!");
...
// Function AIModule.BTFunctionLibrary.SetBlackboardValueAsInt64
// 0x0038 (0x0038 - 0x0000)
struct BTFunctionLibrary_SetBlackboardValueAsInt64 final
{
public:
	class UBTNode*                                NodeOwner;                                         // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBlackboardKeySelector                 Key;                                               // 0x0008(0x0028)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
static_assert(alignof(BTFunctionLibrary_SetBlackboardValueAsInt64) == 0x000008, "Wrong alignment on BTFunctionLibrary_SetBlackboardValueAsInt64");
static_assert(sizeof(BTFunctionLibrary_SetBlackboardValueAsInt64) == 0x000038, "Wrong size on BTFunctionLibrary_SetBlackboardValueAsInt64");
static_assert(offsetof(BTFunctionLibrary_SetBlackboardValueAsInt64, NodeOwner) == 0x000000, "Member 'BTFunctionLibrary_SetBlackboardValueAsInt64::NodeOwner' has a wrong offset!");
static_assert(offsetof(BTFunctionLibrary_SetBlackboardValueAsInt64, Key) == 0x000008, "Member 'BTFunctionLibrary_SetBlackboardValueAsInt64::Key' has a wrong offset!");
static_assert(offsetof(BTFunctionLibrary_SetBlackboardValueAsInt64, Value) == 0x000030, "Member 'BTFunctionLibrary_SetBlackboardValueAsInt64::Value' has a wrong offset!");
