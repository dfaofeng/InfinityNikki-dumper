...
{
public:
	int32                                         WebSocketPort;                                     // 0x08C8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8CC[0xC];                                      // 0x08CC(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWebSocketNetDriver) == 0x0008D8, "Wrong size on UWebSocketNetDriver");
static_assert(offsetof(UWebSocketNetDriver, WebSocketPort) == 0x0008C8, "Member 'UWebSocketNetDriver::WebSocketPort' has a wrong offset!");
