...
static_assert(alignof(BP_PlayerWhiteBoxMovementComponent_C_ExecuteUbergraph_BP_PlayerWhiteBoxMovementComponent) == 0x000004, "Wrong alignment on BP_PlayerWhiteBoxMovementComponent_C_ExecuteUbergraph_BP_PlayerWhiteBoxMovementComponent");
...
struct BP_PlayerWhiteBoxMovementComponent_C_GetModuleName final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
};
static_assert(alignof(BP_PlayerWhiteBoxMovementComponent_C_GetModuleName) == 0x000008, "Wrong alignment on BP_PlayerWhiteBoxMovementComponent_C_GetModuleName");
static_assert(sizeof(BP_PlayerWhiteBoxMovementComponent_C_GetModuleName) == 0x000010, "Wrong size on BP_PlayerWhiteBoxMovementComponent_C_GetModuleName");
static_assert(offsetof(BP_PlayerWhiteBoxMovementComponent_C_GetModuleName, ReturnValue) == 0x000000, "Member 'BP_PlayerWhiteBoxMovementComponent_C_GetModuleName::ReturnValue' has a wrong offset!");
