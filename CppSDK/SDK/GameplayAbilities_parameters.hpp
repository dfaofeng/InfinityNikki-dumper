...
// Function GameplayAbilities.AbilitySystemComponent.HasActivatableTriggeredAbility
// 0x000C (0x000C - 0x0000)
struct AbilitySystemComponent_HasActivatableTriggeredAbility final
{
public:
...
static_assert(alignof(AbilitySystemComponent_HasActivatableTriggeredAbility) == 0x000004, "Wrong alignment on AbilitySystemComponent_HasActivatableTriggeredAbility");
static_assert(sizeof(AbilitySystemComponent_HasActivatableTriggeredAbility) == 0x00000C, "Wrong size on AbilitySystemComponent_HasActivatableTriggeredAbility");
static_assert(offsetof(AbilitySystemComponent_HasActivatableTriggeredAbility, Tag) == 0x000000, "Member 'AbilitySystemComponent_HasActivatableTriggeredAbility::Tag' has a wrong offset!");
static_assert(offsetof(AbilitySystemComponent_HasActivatableTriggeredAbility, ReturnValue) == 0x000008, "Member 'AbilitySystemComponent_HasActivatableTriggeredAbility::ReturnValue' has a wrong offset!");
