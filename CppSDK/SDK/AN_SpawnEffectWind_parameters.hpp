...
static_assert(alignof(AN_SpawnEffectWind_C_Received_Notify) == 0x000008, "Wrong alignment on AN_SpawnEffectWind_C_Received_Notify");
static_assert(sizeof(AN_SpawnEffectWind_C_Received_Notify) == 0x000048, "Wrong size on AN_SpawnEffectWind_C_Received_Notify");
static_assert(offsetof(AN_SpawnEffectWind_C_Received_Notify, MeshComp) == 0x000000, "Member 'AN_SpawnEffectWind_C_Received_Notify::MeshComp' has a wrong offset!");
