...
// Class DataRegistry.DataRegistryFunctionLibrary
// 0x0000 (0x0028 - 0x0028)
class UDataRegistryFunctionLibrary final : public UBlueprintFunctionLibrary
{
public:
	static bool GetDataRegistryRowByColumnKey(const class UDataRegistry* Registry, class FName ColumnName, const class FString& Key, struct FTableRowBase* OutRow, bool bCheckVersion);
	static bool GetDataRegistryRowByColumnKeys(const class UDataRegistry* Registry, const TMap<class FName, class FString>& ColumnsAndKeyMap, struct FTableRowBase* OutRow, bool bCheckVersion);
...
public:
	...
	{
		return StaticClassImpl<"DataRegistryFunctionLibrary">();
	}
	static class UDataRegistryFunctionLibrary* GetDefaultObj()
	{
		return GetDefaultObjImpl<UDataRegistryFunctionLibrary>();
	}
};
static_assert(alignof(UDataRegistryFunctionLibrary) == 0x000008, "Wrong alignment on UDataRegistryFunctionLibrary");
static_assert(sizeof(UDataRegistryFunctionLibrary) == 0x000028, "Wrong size on UDataRegistryFunctionLibrary");
