...
class UPrefabricatorAsset* APrefabActor::GetPrefabAsset() const
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// class UPrefabricatorAssetInterface*     PrefabricatorAssetInterface                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<struct FTransform>*              OutTransform                                           (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// TArray<struct FSoftObjectPath>*         OutAssetReference                                      (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)

void UPrefabricatorBlueprintLibrary::GetStaticMeshFromPrefab(class UPrefabricatorAssetInterface* PrefabricatorAssetInterface, TArray<struct FTransform>* OutTransform, TArray<struct FSoftObjectPath>* OutAssetReference)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("PrefabricatorBlueprintLibrary", "GetStaticMeshFromPrefab");

	Params::PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab Parms{};

	Parms.PrefabricatorAssetInterface = PrefabricatorAssetInterface;
	...
	if (OutAssetReference != nullptr)
		*OutAssetReference = std::move(Parms.OutAssetReference);
}
...
// Parameters:
// class UPrefabricatorAssetInterface*     PrefabricatorAssetInterface                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<struct FUnpackPrefabricatorActorData>*OutActorDatas                                          (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UPrefabricatorBlueprintLibrary::UnpackPrefabricatorActorDatas(class UPrefabricatorAssetInterface* PrefabricatorAssetInterface, TArray<struct FUnpackPrefabricatorActorData>* OutActorDatas)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("PrefabricatorBlueprintLibrary", "UnpackPrefabricatorActorDatas");

	Params::PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas Parms{};
	...
	if (OutActorDatas != nullptr)
		*OutActorDatas = std::move(Parms.OutActorDatas);
