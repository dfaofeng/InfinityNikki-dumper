...
static_assert(alignof(NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToDynamic) == 0x000008, "Wrong alignment on NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToDynamic");
static_assert(sizeof(NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToDynamic) == 0x000008, "Wrong size on NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToDynamic");
static_assert(offsetof(NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToDynamic, WorldContextObject) == 0x000000, "Member 'NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToDynamic::WorldContextObject' has a wrong offset!");

// Function NavigationSystem.NavigationSystemV1.RuntimeChangeRuntimeGenerationModeToStatic
// 0x0008 (0x0008 - 0x0000)
struct NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToStatic final
{
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToStatic) == 0x000008, "Wrong alignment on NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToStatic");
static_assert(sizeof(NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToStatic) == 0x000008, "Wrong size on NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToStatic");
static_assert(offsetof(NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToStatic, WorldContextObject) == 0x000000, "Member 'NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToStatic::WorldContextObject' has a wrong offset!");
