...
public:
	...
	struct FUMGSplineInfo                         SplineInfo;                                        // 0x0190(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FUMGSplineDebugInfo                    SplineDebugInfo;                                   // 0x02A0(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B4[0x14];                                     // 0x02B4(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	struct FUMGSplineCurves                       SplineCurves;                                      // 0x02C8(0x0038)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USplineWidget) == 0x000300, "Wrong size on USplineWidget");
static_assert(offsetof(USplineWidget, SplineInfo) == 0x000190, "Member 'USplineWidget::SplineInfo' has a wrong offset!");
static_assert(offsetof(USplineWidget, SplineDebugInfo) == 0x0002A0, "Member 'USplineWidget::SplineDebugInfo' has a wrong offset!");
static_assert(offsetof(USplineWidget, SplineCurves) == 0x0002C8, "Member 'USplineWidget::SplineCurves' has a wrong offset!");
