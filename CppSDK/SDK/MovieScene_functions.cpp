...
// Parameters:
// bool                                    bInIsActive_Runtime                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMovieSceneSection::SetIsActive_Runtime(bool bInIsActive_Runtime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneSection", "SetIsActive_Runtime");

	Params::MovieSceneSection_SetIsActive_Runtime Parms{};

	Parms.bInIsActive_Runtime = bInIsActive_Runtime;
...
// Parameters:
// EMovieSceneNetPolicy                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EMovieSceneNetPolicy UMovieSceneSection::GetNetPolicy() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneSection", "GetNetPolicy");

	Params::MovieSceneSection_GetNetPolicy Parms{};
