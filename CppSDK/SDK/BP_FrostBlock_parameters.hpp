...
static_assert(alignof(BP_FrostBlock_C_ExecuteUbergraph_BP_FrostBlock) == 0x000004, "Wrong alignment on BP_FrostBlock_C_ExecuteUbergraph_BP_FrostBlock");
...
struct BP_FrostBlock_C_GetModuleName final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
};
static_assert(alignof(BP_FrostBlock_C_GetModuleName) == 0x000008, "Wrong alignment on BP_FrostBlock_C_GetModuleName");
static_assert(sizeof(BP_FrostBlock_C_GetModuleName) == 0x000010, "Wrong size on BP_FrostBlock_C_GetModuleName");
static_assert(offsetof(BP_FrostBlock_C_GetModuleName, ReturnValue) == 0x000000, "Member 'BP_FrostBlock_C_GetModuleName::ReturnValue' has a wrong offset!");
