...
#include "AnimNotify_RunStepSoundV2_classes.hpp"
#include "AnimNotify_RunStepSoundV2_parameters.hpp"
...
void UAnimNotify_RunStepSoundV2_C::PreviewPostAkEvent(class USceneComponent* Comp) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimNotify_RunStepSoundV2_C", "PreviewPostAkEvent");

	Params::AnimNotify_RunStepSoundV2_C_PreviewPostAkEvent Parms{};
