...
int32 UChaosWheeledVehicleMovementComponent::GetNumWheelsOnGround() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ChaosWheeledVehicleMovementComponent", "GetNumWheelsOnGround");

	Params::ChaosWheeledVehicleMovementComponent_GetNumWheelsOnGround Parms{};
...
bool UChaosWheeledVehicleMovementComponent::IsAllWheelsOnGround() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ChaosWheeledVehicleMovementComponent", "IsAllWheelsOnGround");

	Params::ChaosWheeledVehicleMovementComponent_IsAllWheelsOnGround Parms{};
