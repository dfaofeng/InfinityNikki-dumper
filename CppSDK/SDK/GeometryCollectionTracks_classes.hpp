...
{
public:
	struct FMovieSceneGeometryCollectionParams    Params_0;                                          // 0x0120(0x0038)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneGeometryCollectionSection) == 0x000158, "Wrong size on UMovieSceneGeometryCollectionSection");
static_assert(offsetof(UMovieSceneGeometryCollectionSection, Params_0) == 0x000120, "Member 'UMovieSceneGeometryCollectionSection::Params_0' has a wrong offset!");
