...
{
public:
	struct FMovieSceneNiagaraCacheParams          Params_0;                                          // 0x0128(0x0088)(Edit, NativeAccessSpecifierPublic)
	bool                                          bCacheOutOfDate;                                   // 0x01B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneNiagaraCacheSection) == 0x0001B8, "Wrong size on UMovieSceneNiagaraCacheSection");
static_assert(offsetof(UMovieSceneNiagaraCacheSection, Params_0) == 0x000128, "Member 'UMovieSceneNiagaraCacheSection::Params_0' has a wrong offset!");
static_assert(offsetof(UMovieSceneNiagaraCacheSection, bCacheOutOfDate) == 0x0001B0, "Member 'UMovieSceneNiagaraCacheSection::bCacheOutOfDate' has a wrong offset!");
