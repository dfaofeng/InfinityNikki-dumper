...
static_assert(sizeof(MotionWarpingUtilities_ExtractRootMotionFromAnimation) == 0x000080, "Wrong size on MotionWarpingUtilities_ExtractRootMotionFromAnimation");
...
static_assert(offsetof(MotionWarpingUtilities_ExtractRootMotionFromAnimation, bMirror) == 0x000010, "Member 'MotionWarpingUtilities_ExtractRootMotionFromAnimation::bMirror' has a wrong offset!");
static_assert(offsetof(MotionWarpingUtilities_ExtractRootMotionFromAnimation, ReturnValue) == 0x000020, "Member 'MotionWarpingUtilities_ExtractRootMotionFromAnimation::ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          bInWarpIKBones;                                    // 0x009B(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           InIKBones;                                         // 0x00A0(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	class URootMotionModifier_AdjustmentBlendWarp* ReturnValue;                                      // 0x00B0(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp) == 0x0000C0, "Wrong size on RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp");
...
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, InWarpPointAnimProvider) == 0x000020, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::InWarpPointAnimProvider' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, InWarpPointAnimTransform) == 0x000030, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::InWarpPointAnimTransform' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, InWarpPointAnimBoneName) == 0x000090, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::InWarpPointAnimBoneName' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, bInWarpTranslation) == 0x000098, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::bInWarpTranslation' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, bInIgnoreZAxis) == 0x000099, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::bInIgnoreZAxis' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, bInWarpRotation) == 0x00009A, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::bInWarpRotation' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, bInWarpIKBones) == 0x00009B, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::bInWarpIKBones' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, InIKBones) == 0x0000A0, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::InIKBones' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, ReturnValue) == 0x0000B0, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::ReturnValue' has a wrong offset!");
