...
static_assert(offsetof(ARSessionConfig_RemoveCandidateImageAtIndex, Index_0) == 0x000000, "Member 'ARSessionConfig_RemoveCandidateImageAtIndex::Index_0' has a wrong offset!");
