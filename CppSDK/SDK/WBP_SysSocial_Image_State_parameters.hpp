...
static_assert(alignof(WBP_SysSocial_Image_State_C_ExecuteUbergraph_WBP_SysSocial_Image_State) == 0x000004, "Wrong alignment on WBP_SysSocial_Image_State_C_ExecuteUbergraph_WBP_SysSocial_Image_State");
