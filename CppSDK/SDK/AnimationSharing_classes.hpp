...
{
public:
	class UAnimSequence*                          AnimationToPlay;                                   // 0x03C8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UAnimSharingInstance*                   Instance;                                          // 0x03E0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAnimSharingStateInstance) == 0x0003F0, "Wrong size on UAnimSharingStateInstance");
static_assert(offsetof(UAnimSharingStateInstance, AnimationToPlay) == 0x0003C8, "Member 'UAnimSharingStateInstance::AnimationToPlay' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, PermutationTimeOffset) == 0x0003D0, "Member 'UAnimSharingStateInstance::PermutationTimeOffset' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, PlayRate) == 0x0003D4, "Member 'UAnimSharingStateInstance::PlayRate' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, bStateBool) == 0x0003D8, "Member 'UAnimSharingStateInstance::bStateBool' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, Instance) == 0x0003E0, "Member 'UAnimSharingStateInstance::Instance' has a wrong offset!");
...
static_assert(sizeof(UAnimSharingTransitionInstance) == 0x0003E0, "Wrong size on UAnimSharingTransitionInstance");
static_assert(offsetof(UAnimSharingTransitionInstance, FromComponent) == 0x0003C8, "Member 'UAnimSharingTransitionInstance::FromComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, ToComponent) == 0x0003D0, "Member 'UAnimSharingTransitionInstance::ToComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, BlendTime) == 0x0003D8, "Member 'UAnimSharingTransitionInstance::BlendTime' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, bBlendBool) == 0x0003DC, "Member 'UAnimSharingTransitionInstance::bBlendBool' has a wrong offset!");
...
static_assert(sizeof(UAnimSharingAdditiveInstance) == 0x0003E0, "Wrong size on UAnimSharingAdditiveInstance");
static_assert(offsetof(UAnimSharingAdditiveInstance, BaseComponent) == 0x0003C8, "Member 'UAnimSharingAdditiveInstance::BaseComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, AdditiveAnimation) == 0x0003D0, "Member 'UAnimSharingAdditiveInstance::AdditiveAnimation' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, alpha) == 0x0003D8, "Member 'UAnimSharingAdditiveInstance::alpha' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, bStateBool) == 0x0003DC, "Member 'UAnimSharingAdditiveInstance::bStateBool' has a wrong offset!");
