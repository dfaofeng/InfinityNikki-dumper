...
public:
	...
	class UWwiseAudioLinkSettings*                Settings;                                          // 0x0408(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundBase*                             Sound;                                             // 0x0410(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoPlay;                                         // 0x0418(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_419[0x7];                                      // 0x0419(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAudioComponent*                        AudioComponent;                                    // 0x0420(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWwiseAudioLinkComponent) == 0x000430, "Wrong size on UWwiseAudioLinkComponent");
static_assert(offsetof(UWwiseAudioLinkComponent, Settings) == 0x000408, "Member 'UWwiseAudioLinkComponent::Settings' has a wrong offset!");
static_assert(offsetof(UWwiseAudioLinkComponent, Sound) == 0x000410, "Member 'UWwiseAudioLinkComponent::Sound' has a wrong offset!");
static_assert(offsetof(UWwiseAudioLinkComponent, bAutoPlay) == 0x000418, "Member 'UWwiseAudioLinkComponent::bAutoPlay' has a wrong offset!");
static_assert(offsetof(UWwiseAudioLinkComponent, AudioComponent) == 0x000420, "Member 'UWwiseAudioLinkComponent::AudioComponent' has a wrong offset!");
