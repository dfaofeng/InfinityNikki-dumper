...
#include "WBP_SysSocial_Marker_classes.hpp"
#include "WBP_SysSocial_Marker_parameters.hpp"
...
void UWBP_SysSocial_Marker_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_SysSocial_Marker_C", "PreConstruct");
...
class FString UWBP_SysSocial_Marker_C::GetModuleName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_SysSocial_Marker_C", "GetModuleName");

	Params::WBP_SysSocial_Marker_C_GetModuleName Parms{};
