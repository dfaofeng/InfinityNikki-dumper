...
{
public:
	class UConstraintsManager*                    ConstraintsManager;                                // 0x03A8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AConstraintsActor) == 0x0003B0, "Wrong size on AConstraintsActor");
static_assert(offsetof(AConstraintsActor, ConstraintsManager) == 0x0003A8, "Member 'AConstraintsActor::ConstraintsManager' has a wrong offset!");
