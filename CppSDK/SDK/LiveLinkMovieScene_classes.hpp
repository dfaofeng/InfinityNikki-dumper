...
{
public:
	struct FLiveLinkSubjectPreset                 SubjectPreset;                                     // 0x0120(0x0038)(NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<bool>                                  ChannelMask;                                       // 0x0158(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UMovieSceneLiveLinkSubSection*>  SubSections;                                       // 0x0168(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_178[0x10];                                     // 0x0178(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SubjectName;                                       // 0x0188(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLiveLinkFrameData                     TemplateToPush;                                    // 0x0190(0x0090)(Deprecated, NativeAccessSpecifierPublic)
	struct FLiveLinkRefSkeleton                   RefSkeleton;                                       // 0x0220(0x0020)(Deprecated, NativeAccessSpecifierPublic)
	TArray<class FName>                           CurveNames;                                        // 0x0240(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	TArray<struct FMovieSceneFloatChannel>        PropertyFloatChannels;                             // 0x0250(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneLiveLinkSection) == 0x000260, "Wrong size on UMovieSceneLiveLinkSection");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubjectPreset) == 0x000120, "Member 'UMovieSceneLiveLinkSection::SubjectPreset' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, ChannelMask) == 0x000158, "Member 'UMovieSceneLiveLinkSection::ChannelMask' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubSections) == 0x000168, "Member 'UMovieSceneLiveLinkSection::SubSections' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubjectName) == 0x000188, "Member 'UMovieSceneLiveLinkSection::SubjectName' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, TemplateToPush) == 0x000190, "Member 'UMovieSceneLiveLinkSection::TemplateToPush' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, RefSkeleton) == 0x000220, "Member 'UMovieSceneLiveLinkSection::RefSkeleton' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, CurveNames) == 0x000240, "Member 'UMovieSceneLiveLinkSection::CurveNames' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, PropertyFloatChannels) == 0x000250, "Member 'UMovieSceneLiveLinkSection::PropertyFloatChannels' has a wrong offset!");
