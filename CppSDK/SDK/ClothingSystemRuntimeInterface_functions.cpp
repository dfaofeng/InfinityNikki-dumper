...
// (RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// int32                                   ExtraNumber                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UClothingSimulationInteractor::SetPreExtraSimulationNumber(int32 ExtraNumber)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ClothingSimulationInteractor", "SetPreExtraSimulationNumber");

	Params::ClothingSimulationInteractor_SetPreExtraSimulationNumber Parms{};

	Parms.ExtraNumber = ExtraNumber;
