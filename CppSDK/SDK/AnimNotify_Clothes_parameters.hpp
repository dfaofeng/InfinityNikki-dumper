...
static_assert(alignof(AnimNotify_Clothes_C_Received_Notify) == 0x000008, "Wrong alignment on AnimNotify_Clothes_C_Received_Notify");
static_assert(sizeof(AnimNotify_Clothes_C_Received_Notify) == 0x000060, "Wrong size on AnimNotify_Clothes_C_Received_Notify");
static_assert(offsetof(AnimNotify_Clothes_C_Received_Notify, MeshComp) == 0x000000, "Member 'AnimNotify_Clothes_C_Received_Notify::MeshComp' has a wrong offset!");
static_assert(offsetof(AnimNotify_Clothes_C_Received_Notify, Animation) == 0x000008, "Member 'AnimNotify_Clothes_C_Received_Notify::Animation' has a wrong offset!");
static_assert(offsetof(AnimNotify_Clothes_C_Received_Notify, EventReference) == 0x000010, "Member 'AnimNotify_Clothes_C_Received_Notify::EventReference' has a wrong offset!");
static_assert(offsetof(AnimNotify_Clothes_C_Received_Notify, ReturnValue) == 0x000040, "Member 'AnimNotify_Clothes_C_Received_Notify::ReturnValue' has a wrong offset!");
