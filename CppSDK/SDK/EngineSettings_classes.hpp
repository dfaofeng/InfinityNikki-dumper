...
public:
	...
	struct FSoftClassPath                         PaperHotUpdateGameInstanceClass;                   // 0x0080(0x0020)(Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         LevelExternalPackagePathUseInner;                  // 0x00A0(0x0010)(Edit, ZeroConstructor, Config, GlobalConfig, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        GameDefaultMap;                                    // 0x00B0(0x0020)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftObjectPath                        ServerDefaultMap;                                  // 0x00D0(0x0020)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                         GlobalDefaultGameMode;                             // 0x00F0(0x0020)(Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                         GlobalDefaultServerGameMode;                       // 0x0110(0x0020)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FGameModeName>                  GameModeMapPrefixes;                               // 0x0130(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
	TArray<struct FGameModeName>                  GameModeClassAliases;                              // 0x0140(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameMapsSettings) == 0x000150, "Wrong size on UGameMapsSettings");
...
static_assert(offsetof(UGameMapsSettings, PaperHotUpdateGameInstanceClass) == 0x000080, "Member 'UGameMapsSettings::PaperHotUpdateGameInstanceClass' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, LevelExternalPackagePathUseInner) == 0x0000A0, "Member 'UGameMapsSettings::LevelExternalPackagePathUseInner' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameDefaultMap) == 0x0000B0, "Member 'UGameMapsSettings::GameDefaultMap' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, ServerDefaultMap) == 0x0000D0, "Member 'UGameMapsSettings::ServerDefaultMap' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GlobalDefaultGameMode) == 0x0000F0, "Member 'UGameMapsSettings::GlobalDefaultGameMode' has a wrong offset!");
...
static_assert(offsetof(UGameMapsSettings, GameModeMapPrefixes) == 0x000130, "Member 'UGameMapsSettings::GameModeMapPrefixes' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameModeClassAliases) == 0x000140, "Member 'UGameMapsSettings::GameModeClassAliases' has a wrong offset!");
