...
#include "ABP_Animal_ControlBase_classes.hpp"
#include "ABP_Animal_ControlBase_parameters.hpp"
...
void UABP_Animal_ControlBase_C::BlueprintUpdateAnimation(float DeltaTimeX)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ABP_Animal_ControlBase_C", "BlueprintUpdateAnimation");

	Params::ABP_Animal_ControlBase_C_BlueprintUpdateAnimation Parms{};
