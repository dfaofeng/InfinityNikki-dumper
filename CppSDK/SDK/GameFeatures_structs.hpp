...
static_assert(offsetof(FGameFeatureComponentEntry, AdditionFlags) == 0x000051, "Member 'FGameFeatureComponentEntry::AdditionFlags' has a wrong offset!");
...
static_assert(sizeof(FGameFeaturePluginStateMachineProperties) == 0x0000D0, "Wrong size on FGameFeaturePluginStateMachineProperties");
static_assert(offsetof(FGameFeaturePluginStateMachineProperties, GameFeatureData) == 0x000090, "Member 'FGameFeaturePluginStateMachineProperties::GameFeatureData' has a wrong offset!");
...
static_assert(alignof(FInstallBundlePluginProtocolOptions) == 0x000004, "Wrong alignment on FInstallBundlePluginProtocolOptions");
static_assert(sizeof(FInstallBundlePluginProtocolOptions) == 0x00000C, "Wrong size on FInstallBundlePluginProtocolOptions");
