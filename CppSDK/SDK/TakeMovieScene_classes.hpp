...
{
public:
	struct FMovieSceneIntegerChannel              HoursCurve;                                        // 0x0120(0x0108)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              MinutesCurve;                                      // 0x0228(0x0108)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              SecondsCurve;                                      // 0x0330(0x0108)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              FramesCurve;                                       // 0x0438(0x0108)(NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel                SubFramesCurve;                                    // 0x0540(0x0110)(NativeAccessSpecifierPublic)
	struct FMovieSceneStringChannel               Slate;                                             // 0x0650(0x0110)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneTakeSection) == 0x000760, "Wrong size on UMovieSceneTakeSection");
static_assert(offsetof(UMovieSceneTakeSection, HoursCurve) == 0x000120, "Member 'UMovieSceneTakeSection::HoursCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, MinutesCurve) == 0x000228, "Member 'UMovieSceneTakeSection::MinutesCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, SecondsCurve) == 0x000330, "Member 'UMovieSceneTakeSection::SecondsCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, FramesCurve) == 0x000438, "Member 'UMovieSceneTakeSection::FramesCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, SubFramesCurve) == 0x000540, "Member 'UMovieSceneTakeSection::SubFramesCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, Slate) == 0x000650, "Member 'UMovieSceneTakeSection::Slate' has a wrong offset!");
