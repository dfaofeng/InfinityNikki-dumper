...
{
public:
	class UPrefabComponent*                       PrefabComponent;                                   // 0x03A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  LastUpdateID;                                      // 0x03B0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Seed;                                              // 0x03C0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class UPrefabricatorAsset* GetPrefabAsset() const;
...
static_assert(sizeof(APrefabActor) == 0x0003C8, "Wrong size on APrefabActor");
static_assert(offsetof(APrefabActor, PrefabComponent) == 0x0003A8, "Member 'APrefabActor::PrefabComponent' has a wrong offset!");
static_assert(offsetof(APrefabActor, LastUpdateID) == 0x0003B0, "Member 'APrefabActor::LastUpdateID' has a wrong offset!");
static_assert(offsetof(APrefabActor, Seed) == 0x0003C0, "Member 'APrefabActor::Seed' has a wrong offset!");
...
static_assert(sizeof(AReplicablePrefabActor) == 0x0003C8, "Wrong size on AReplicablePrefabActor");
...
{
public:
	TSoftObjectPtr<class UPrefabricatorAssetInterface> PrefabAssetInterface;                         // 0x0230(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPrefabComponent, PrefabAssetInterface) == 0x000230, "Member 'UPrefabComponent::PrefabAssetInterface' has a wrong offset!");
...
{
public:
	class AActor*                                 Actor;                                             // 0x03A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ActorData;                                         // 0x03B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APrefabDebugActor) == 0x0003C0, "Wrong size on APrefabDebugActor");
static_assert(offsetof(APrefabDebugActor, Actor) == 0x0003A8, "Member 'APrefabDebugActor::Actor' has a wrong offset!");
static_assert(offsetof(APrefabDebugActor, ActorData) == 0x0003B0, "Member 'APrefabDebugActor::ActorData' has a wrong offset!");
...
{
public:
	bool                                          bRandomizeOnBeginPlay;                             // 0x03A8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3A9[0x3];                                      // 0x03A9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SeedOffset;                                        // 0x03AC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxBuildTimePerFrame;                              // 0x03B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3B4[0x4];                                      // 0x03B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void()>              OnRandomizationComplete;                           // 0x03B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bFastSyncBuild;                                    // 0x03C8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3C9[0x7];                                      // 0x03C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class APrefabActor*>                   ActorsToRandomize;                                 // 0x03D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APrefabRandomizer) == 0x0003F8, "Wrong size on APrefabRandomizer");
static_assert(offsetof(APrefabRandomizer, bRandomizeOnBeginPlay) == 0x0003A8, "Member 'APrefabRandomizer::bRandomizeOnBeginPlay' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, SeedOffset) == 0x0003AC, "Member 'APrefabRandomizer::SeedOffset' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, MaxBuildTimePerFrame) == 0x0003B0, "Member 'APrefabRandomizer::MaxBuildTimePerFrame' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, OnRandomizationComplete) == 0x0003B8, "Member 'APrefabRandomizer::OnRandomizationComplete' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, bFastSyncBuild) == 0x0003C8, "Member 'APrefabRandomizer::bFastSyncBuild' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, ActorsToRandomize) == 0x0003D0, "Member 'APrefabRandomizer::ActorsToRandomize' has a wrong offset!");
...
public:
	...
	static void GetStaticMeshFromPrefab(class UPrefabricatorAssetInterface* PrefabricatorAssetInterface, TArray<struct FTransform>* OutTransform, TArray<struct FSoftObjectPath>* OutAssetReference);
	...
	static bool UnpackPrefabricatorActorDatas(class UPrefabricatorAssetInterface* PrefabricatorAssetInterface, TArray<struct FUnpackPrefabricatorActorData>* OutActorDatas);
...
{
public:
	TArray<TWeakObjectPtr<class APrefabActor>>    LinkedActors;                                      // 0x03A8(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	class UPrefabSeedLinkerComponent*             SeedLinkerComponent;                               // 0x03B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APrefabSeedLinker) == 0x0003C0, "Wrong size on APrefabSeedLinker");
static_assert(offsetof(APrefabSeedLinker, LinkedActors) == 0x0003A8, "Member 'APrefabSeedLinker::LinkedActors' has a wrong offset!");
static_assert(offsetof(APrefabSeedLinker, SeedLinkerComponent) == 0x0003B8, "Member 'APrefabSeedLinker::SeedLinkerComponent' has a wrong offset!");
