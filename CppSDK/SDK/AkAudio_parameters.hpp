...
// Function AkAudio.AkAudioEvent.GetLocalizedMaximumDuration
// 0x0018 (0x0018 - 0x0000)
struct AkAudioEvent_GetLocalizedMaximumDuration final
{
public:
	class FString                                 LanguageName;                                      // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ReturnValue;                                       // 0x0010(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AkAudioEvent_GetLocalizedMaximumDuration) == 0x000008, "Wrong alignment on AkAudioEvent_GetLocalizedMaximumDuration");
static_assert(sizeof(AkAudioEvent_GetLocalizedMaximumDuration) == 0x000018, "Wrong size on AkAudioEvent_GetLocalizedMaximumDuration");
static_assert(offsetof(AkAudioEvent_GetLocalizedMaximumDuration, LanguageName) == 0x000000, "Member 'AkAudioEvent_GetLocalizedMaximumDuration::LanguageName' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_GetLocalizedMaximumDuration, ReturnValue) == 0x000010, "Member 'AkAudioEvent_GetLocalizedMaximumDuration::ReturnValue' has a wrong offset!");
...
// Function AkAudio.AkGameplayStatics.GetSpatialAudioListener
// 0x0008 (0x0008 - 0x0000)
struct AkGameplayStatics_GetSpatialAudioListener final
{
public:
...
static_assert(alignof(AkGameplayStatics_GetSpatialAudioListener) == 0x000008, "Wrong alignment on AkGameplayStatics_GetSpatialAudioListener");
static_assert(sizeof(AkGameplayStatics_GetSpatialAudioListener) == 0x000008, "Wrong size on AkGameplayStatics_GetSpatialAudioListener");
static_assert(offsetof(AkGameplayStatics_GetSpatialAudioListener, ReturnValue) == 0x000000, "Member 'AkGameplayStatics_GetSpatialAudioListener::ReturnValue' has a wrong offset!");
