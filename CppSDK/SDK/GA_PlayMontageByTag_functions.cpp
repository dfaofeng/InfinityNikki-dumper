...
#include "GA_PlayMontageByTag_classes.hpp"
#include "GA_PlayMontageByTag_parameters.hpp"
...
void UGA_PlayMontageByTag_C::K2_ActivateAbilityFromEvent(const struct FGameplayEventData& EventData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_PlayMontageByTag_C", "K2_ActivateAbilityFromEvent");

	Params::GA_PlayMontageByTag_C_K2_ActivateAbilityFromEvent Parms{};
...
bool UGA_PlayMontageByTag_C::K2_ShouldAbilityRespondToEvent(const struct FGameplayAbilityActorInfo& ActorInfo, const struct FGameplayEventData& Payload) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_PlayMontageByTag_C", "K2_ShouldAbilityRespondToEvent");

	Params::GA_PlayMontageByTag_C_K2_ShouldAbilityRespondToEvent Parms{};
