...
// (Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bSkipBroadcast                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void IAssetRegistry::WaitForCompletion(bool bSkipBroadcast)
{
	static class UFunction* Func = nullptr;
	...
	Params::AssetRegistry_WaitForCompletion Parms{};

	Parms.bSkipBroadcast = bSkipBroadcast;
