...
public:
	...
	float                                         MaximumDuration;                                   // 0x0004(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FWwiseSoundBankCookedData>      SoundBanks;                                        // 0x0008(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FWwiseMediaCookedData>          Media;                                             // 0x0018(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FWwiseEventCookedData, MaximumDuration) == 0x000004, "Member 'FWwiseEventCookedData::MaximumDuration' has a wrong offset!");
...
public:
	...
	class FString                                 ReferenceEventPaths;                               // 0x0028(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWwiseEventInfo) == 0x000008, "Wrong alignment on FWwiseEventInfo");
static_assert(sizeof(FWwiseEventInfo) == 0x000038, "Wrong size on FWwiseEventInfo");
...
static_assert(offsetof(FWwiseEventInfo, ReferenceEventPaths) == 0x000028, "Member 'FWwiseEventInfo::ReferenceEventPaths' has a wrong offset!");
