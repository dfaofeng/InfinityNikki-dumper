...
public:
	...
	struct FPostProcessSettings                   K2Node_MakeStruct_PostProcessSettings;             // 0x0870(0x0850)()
};
...
static_assert(sizeof(BP_StarSeaCameraModifier_C_BlueprintModifyPostProcess) == 0x0010C0, "Wrong size on BP_StarSeaCameraModifier_C_BlueprintModifyPostProcess");
...
static_assert(sizeof(BP_StarSeaCameraModifier_C_BP_SetDynamicMat) == 0x000020, "Wrong size on BP_StarSeaCameraModifier_C_BP_SetDynamicMat");
...
static_assert(offsetof(BP_StarSeaCameraModifier_C_BP_SetDynamicMat, K2Node_MakeStruct_WeightedBlendable) == 0x000008, "Member 'BP_StarSeaCameraModifier_C_BP_SetDynamicMat::K2Node_MakeStruct_WeightedBlendable' has a wrong offset!");
static_assert(offsetof(BP_StarSeaCameraModifier_C_BP_SetDynamicMat, CallFunc_Array_Add_ReturnValue) == 0x000018, "Member 'BP_StarSeaCameraModifier_C_BP_SetDynamicMat::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
