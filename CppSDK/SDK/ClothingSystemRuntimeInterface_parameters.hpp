...
// Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.SetPreExtraSimulationNumber
// 0x0004 (0x0004 - 0x0000)
struct ClothingSimulationInteractor_SetPreExtraSimulationNumber final
{
public:
	int32                                         ExtraNumber;                                       // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ClothingSimulationInteractor_SetPreExtraSimulationNumber) == 0x000004, "Wrong alignment on ClothingSimulationInteractor_SetPreExtraSimulationNumber");
static_assert(sizeof(ClothingSimulationInteractor_SetPreExtraSimulationNumber) == 0x000004, "Wrong size on ClothingSimulationInteractor_SetPreExtraSimulationNumber");
static_assert(offsetof(ClothingSimulationInteractor_SetPreExtraSimulationNumber, ExtraNumber) == 0x000000, "Member 'ClothingSimulationInteractor_SetPreExtraSimulationNumber::ExtraNumber' has a wrong offset!");
