...
// Function MovieRenderPipelineCore.MoviePipeline.SetCustomInitializeFinished
// 0x0001 (0x0001 - 0x0000)
struct MoviePipeline_SetCustomInitializeFinished final
{
public:
	bool                                          bInCustomInitializeFinished;                       // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MoviePipeline_SetCustomInitializeFinished) == 0x000001, "Wrong alignment on MoviePipeline_SetCustomInitializeFinished");
static_assert(sizeof(MoviePipeline_SetCustomInitializeFinished) == 0x000001, "Wrong size on MoviePipeline_SetCustomInitializeFinished");
static_assert(offsetof(MoviePipeline_SetCustomInitializeFinished, bInCustomInitializeFinished) == 0x000000, "Member 'MoviePipeline_SetCustomInitializeFinished::bInCustomInitializeFinished' has a wrong offset!");
