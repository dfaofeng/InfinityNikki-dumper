...
static_assert(alignof(BTT_QuadrupedAnimalReaction_InitAfterFlee_C_ExecuteUbergraph_BTT_QuadrupedAnimalReaction_InitAfterFlee) == 0x000008, "Wrong alignment on BTT_QuadrupedAnimalReaction_InitAfterFlee_C_ExecuteUbergraph_BTT_QuadrupedAnimalReaction_InitAfterFlee");
static_assert(sizeof(BTT_QuadrupedAnimalReaction_InitAfterFlee_C_ExecuteUbergraph_BTT_QuadrupedAnimalReaction_InitAfterFlee) == 0x000018, "Wrong size on BTT_QuadrupedAnimalReaction_InitAfterFlee_C_ExecuteUbergraph_BTT_QuadrupedAnimalReaction_InitAfterFlee");
