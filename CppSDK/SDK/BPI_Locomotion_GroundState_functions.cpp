...
#include "BPI_Locomotion_GroundState_classes.hpp"
#include "BPI_Locomotion_GroundState_parameters.hpp"
...
void IBPI_Locomotion_GroundState_C::BPI_Get_PlayerStates(bool* IsInState_AimMode)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPI_Locomotion_GroundState_C", "BPI_Get_PlayerStates");

	Params::BPI_Locomotion_GroundState_C_BPI_Get_PlayerStates Parms{};
...
void IBPI_Locomotion_GroundState_C::BPI_Get_MaxSpeedValues(double* CurMinAnalogWalkSpeed, double* CurConfigMaxSpeed, double* CurActualMaxSpeed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPI_Locomotion_GroundState_C", "BPI_Get_MaxSpeedValues");

	Params::BPI_Locomotion_GroundState_C_BPI_Get_MaxSpeedValues Parms{};
...
void IBPI_Locomotion_GroundState_C::BPI_Get_EssentialValues(struct FVector* InVelocity, struct FVector* InCurrentAcceleration, double* InMaxAcceleration, double* InTurnAroundAngle, double* InSlopeAngle, double* InStartTurnAroundAngle, double* InCurConfigMaxSpeed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPI_Locomotion_GroundState_C", "BPI_Get_EssentialValues");

	Params::BPI_Locomotion_GroundState_C_BPI_Get_EssentialValues Parms{};
...
void IBPI_Locomotion_GroundState_C::BPI_Get_CurrentGroundStates(EMovementMode* PawnMovementMode, ERegularLocomotionType* AllowedGait, EPlayerMovementScenarios* MovementScenario, EInputDeviceKeyType* CurInputDeviceKeyType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPI_Locomotion_GroundState_C", "BPI_Get_CurrentGroundStates");

	Params::BPI_Locomotion_GroundState_C_BPI_Get_CurrentGroundStates Parms{};
...
void IBPI_Locomotion_GroundState_C::BPI_Get_ConfigData(double* WalkSpeed, double* RunSpeed, double* SprintSpeed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPI_Locomotion_GroundState_C", "BPI_Get_ConfigData");

	Params::BPI_Locomotion_GroundState_C_BPI_Get_ConfigData Parms{};
...
void IBPI_Locomotion_GroundState_C::BPI_Get_BalanceBeamStates(bool* CanMoveOnValidInput, bool* IsEnterTowardSideOfBeam, bool* IsCurInputValid)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPI_Locomotion_GroundState_C", "BPI_Get_BalanceBeamStates");

	Params::BPI_Locomotion_GroundState_C_BPI_Get_BalanceBeamStates Parms{};
