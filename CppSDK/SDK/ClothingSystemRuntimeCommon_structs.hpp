...
// Enum ClothingSystemRuntimeCommon.EClothingVirtualParticleTypeNv
// NumValues: 0x0004
enum class EClothingVirtualParticleTypeNv : uint8
{
	None                                     = 0,
	TriangleCenter                           = 1,
	EdgeCenter                               = 2,
	EClothingVirtualParticleTypeNv_MAX       = 3,
};
...
// ScriptStruct ClothingSystemRuntimeCommon.IntArrayData
// 0x0010 (0x0010 - 0x0000)
struct FIntArrayData final
{
public:
	TArray<int32>                                 IntArrayData;                                      // 0x0000(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FIntArrayData) == 0x000008, "Wrong alignment on FIntArrayData");
...
struct FClothPhysicalSpringData final
{
public:
	...
	TArray<float>                                 Dists;                                             // 0x0020(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_30[0x10];                                      // 0x0030(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FClothPhysicalSpringData) == 0x000008, "Wrong alignment on FClothPhysicalSpringData");
static_assert(sizeof(FClothPhysicalSpringData) == 0x000040, "Wrong size on FClothPhysicalSpringData");
static_assert(offsetof(FClothPhysicalSpringData, ConstraintsPerColorIntArray) == 0x000000, "Member 'FClothPhysicalSpringData::ConstraintsPerColorIntArray' has a wrong offset!");
static_assert(offsetof(FClothPhysicalSpringData, Constraints) == 0x000010, "Member 'FClothPhysicalSpringData::Constraints' has a wrong offset!");
static_assert(offsetof(FClothPhysicalSpringData, Dists) == 0x000020, "Member 'FClothPhysicalSpringData::Dists' has a wrong offset!");
...
{
public:
	TArray<int32>                                 Elements;                                          // 0x0000(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FIntArrayData>                  PointToTriangleMapIntArray;                        // 0x0010(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 BendingElements;                                   // 0x0020(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         NumIndices;                                        // 0x0030(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34[0x14];                                      // 0x0034(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FClothPhysicalTriangleData) == 0x000008, "Wrong alignment on FClothPhysicalTriangleData");
static_assert(sizeof(FClothPhysicalTriangleData) == 0x000048, "Wrong size on FClothPhysicalTriangleData");
static_assert(offsetof(FClothPhysicalTriangleData, Elements) == 0x000000, "Member 'FClothPhysicalTriangleData::Elements' has a wrong offset!");
...
// ScriptStruct ClothingSystemRuntimeCommon.ClothPhysicalBendingData
// 0x0040 (0x0040 - 0x0000)
struct FClothPhysicalBendingData final
{
public:
	TArray<struct FIntArrayData>                  ConstraintsPerColorIntArray;                       // 0x0000(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 Constraints;                                       // 0x0010(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 RestAngles;                                        // 0x0020(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_30[0x10];                                      // 0x0030(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FClothPhysicalBendingData) == 0x000008, "Wrong alignment on FClothPhysicalBendingData");
static_assert(sizeof(FClothPhysicalBendingData) == 0x000040, "Wrong size on FClothPhysicalBendingData");
static_assert(offsetof(FClothPhysicalBendingData, ConstraintsPerColorIntArray) == 0x000000, "Member 'FClothPhysicalBendingData::ConstraintsPerColorIntArray' has a wrong offset!");
static_assert(offsetof(FClothPhysicalBendingData, Constraints) == 0x000010, "Member 'FClothPhysicalBendingData::Constraints' has a wrong offset!");
static_assert(offsetof(FClothPhysicalBendingData, RestAngles) == 0x000020, "Member 'FClothPhysicalBendingData::RestAngles' has a wrong offset!");
...
public:
	...
	struct FClothPhysicalTriangleData             TriangleData;                                      // 0x0118(0x0048)(Edit, EditConst, NativeAccessSpecifierPublic)
	struct FClothPhysicalSpringData               SpringData;                                        // 0x0160(0x0040)(Edit, EditConst, NativeAccessSpecifierPublic)
	struct FClothPhysicalSpringData               BendingData;                                       // 0x01A0(0x0040)(Edit, EditConst, NativeAccessSpecifierPublic)
	struct FClothPhysicalBendingData              BendingElementData;                                // 0x01E0(0x0040)(Edit, EditConst, NativeAccessSpecifierPublic)
	struct FClothPhysicalAxialSpringData          AxialSpringData;                                   // 0x0220(0x0050)(Edit, EditConst, NativeAccessSpecifierPublic)
	TArray<uint32>                                SelfCollisionIndices;                              // 0x0270(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FClothPhysicalMeshData) == 0x000008, "Wrong alignment on FClothPhysicalMeshData");
static_assert(sizeof(FClothPhysicalMeshData) == 0x000280, "Wrong size on FClothPhysicalMeshData");
...
static_assert(offsetof(FClothPhysicalMeshData, TriangleData) == 0x000118, "Member 'FClothPhysicalMeshData::TriangleData' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, SpringData) == 0x000160, "Member 'FClothPhysicalMeshData::SpringData' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, BendingData) == 0x0001A0, "Member 'FClothPhysicalMeshData::BendingData' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, BendingElementData) == 0x0001E0, "Member 'FClothPhysicalMeshData::BendingElementData' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, AxialSpringData) == 0x000220, "Member 'FClothPhysicalMeshData::AxialSpringData' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, SelfCollisionIndices) == 0x000270, "Member 'FClothPhysicalMeshData::SelfCollisionIndices' has a wrong offset!");
...
{
public:
	struct FClothPhysicalMeshData                 PhysicalMeshData;                                  // 0x0000(0x0280)(Edit, NativeAccessSpecifierPublic)
	TArray<int32>                                 A2OTriangleMap;                                    // 0x0280(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<int32>                                 O2ATriangleMap;                                    // 0x0290(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<int32>                                 A2OParticleMap;                                    // 0x02A0(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<int32>                                 O2AParticleMap;                                    // 0x02B0(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	struct FClothPhysicalMeshData                 RefinedMeshData;                                   // 0x02C0(0x0280)(Edit, NativeAccessSpecifierPublic)
	struct FClothCollisionData                    CollisionData;                                     // 0x0540(0x0040)(Edit, NativeAccessSpecifierPublic)
	bool                                          bUseMultipleInfluences;                            // 0x0580(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_581[0x3];                                      // 0x0581(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SkinningKernelRadius;                              // 0x0584(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSmoothTransition;                                 // 0x0588(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_589[0x27];                                     // 0x0589(0x0027)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FClothLODDataCommon) == 0x000008, "Wrong alignment on FClothLODDataCommon");
static_assert(sizeof(FClothLODDataCommon) == 0x0005B0, "Wrong size on FClothLODDataCommon");
...
static_assert(offsetof(FClothLODDataCommon, A2OTriangleMap) == 0x000280, "Member 'FClothLODDataCommon::A2OTriangleMap' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, O2ATriangleMap) == 0x000290, "Member 'FClothLODDataCommon::O2ATriangleMap' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, A2OParticleMap) == 0x0002A0, "Member 'FClothLODDataCommon::A2OParticleMap' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, O2AParticleMap) == 0x0002B0, "Member 'FClothLODDataCommon::O2AParticleMap' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, RefinedMeshData) == 0x0002C0, "Member 'FClothLODDataCommon::RefinedMeshData' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, CollisionData) == 0x000540, "Member 'FClothLODDataCommon::CollisionData' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, bUseMultipleInfluences) == 0x000580, "Member 'FClothLODDataCommon::bUseMultipleInfluences' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, SkinningKernelRadius) == 0x000584, "Member 'FClothLODDataCommon::SkinningKernelRadius' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, bSmoothTransition) == 0x000588, "Member 'FClothLODDataCommon::bSmoothTransition' has a wrong offset!");
