...
// Class MovieScene.MovieSceneGroupTrackInterface
// 0x0000 (0x0098 - 0x0098)
class UMovieSceneGroupTrackInterface : public UMovieSceneNameableTrack
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieSceneGroupTrackInterface">();
	}
	static class UMovieSceneGroupTrackInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieSceneGroupTrackInterface>();
	}
};
static_assert(alignof(UMovieSceneGroupTrackInterface) == 0x000008, "Wrong alignment on UMovieSceneGroupTrackInterface");
static_assert(sizeof(UMovieSceneGroupTrackInterface) == 0x000098, "Wrong size on UMovieSceneGroupTrackInterface");
...
{
public:
	struct FGuid                                  GroupGuid;                                         // 0x0058(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  SyncGuid;                                          // 0x0068(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  UniqueGuid;                                        // 0x0078(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneSectionEvalOptions          EvalOptions;                                       // 0x0088(0x0002)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_8A[0x6];                                       // 0x008A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneEasingSettings              Easing;                                            // 0x0090(0x0038)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FMovieSceneFrameRange                  SectionRange;                                      // 0x00C8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FFrameNumber                           PreRollFrames;                                     // 0x00D8(0x0004)(Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FFrameNumber                           PostRollFrames;                                    // 0x00DC(0x0004)(Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         RowIndex;                                          // 0x00E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         OverlapPriority;                                   // 0x00E4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bIsActive : 1;                                     // 0x00E8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bIsActive_Runtime : 1;                             // 0x00E8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bIsLocked : 1;                                     // 0x00E8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_E9[0x3];                                       // 0x00E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EMovieSceneNetPolicy                          NetPolicy;                                         // 0x00EC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_ED[0x3];                                       // 0x00ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StartTime;                                         // 0x00F0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         EndTime;                                           // 0x00F4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PrerollTime;                                       // 0x00F8(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PostrollTime;                                      // 0x00FC(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bIsInfinite : 1;                                   // 0x0100(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_101[0x3];                                      // 0x0101(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bSupportsInfiniteRange;                            // 0x0104(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FOptionalMovieSceneBlendType           BlendType;                                         // 0x0105(0x0002)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_107[0x19];                                     // 0x0107(0x0019)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetIsActive_Runtime(bool bInIsActive_Runtime);
	...
	EMovieSceneNetPolicy GetNetPolicy() const;
...
static_assert(offsetof(UMovieSceneSection, GroupGuid) == 0x000058, "Member 'UMovieSceneSection::GroupGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, SyncGuid) == 0x000068, "Member 'UMovieSceneSection::SyncGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, UniqueGuid) == 0x000078, "Member 'UMovieSceneSection::UniqueGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, EvalOptions) == 0x000088, "Member 'UMovieSceneSection::EvalOptions' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, Easing) == 0x000090, "Member 'UMovieSceneSection::Easing' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, SectionRange) == 0x0000C8, "Member 'UMovieSceneSection::SectionRange' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PreRollFrames) == 0x0000D8, "Member 'UMovieSceneSection::PreRollFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PostRollFrames) == 0x0000DC, "Member 'UMovieSceneSection::PostRollFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, RowIndex) == 0x0000E0, "Member 'UMovieSceneSection::RowIndex' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, OverlapPriority) == 0x0000E4, "Member 'UMovieSceneSection::OverlapPriority' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, NetPolicy) == 0x0000EC, "Member 'UMovieSceneSection::NetPolicy' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSection, PrerollTime) == 0x0000F8, "Member 'UMovieSceneSection::PrerollTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PostrollTime) == 0x0000FC, "Member 'UMovieSceneSection::PostrollTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, bSupportsInfiniteRange) == 0x000104, "Member 'UMovieSceneSection::bSupportsInfiniteRange' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, BlendType) == 0x000105, "Member 'UMovieSceneSection::BlendType' has a wrong offset!");

// Class MovieScene.MovieSceneGroupSectionInterface
// 0x0000 (0x0120 - 0x0120)
class UMovieSceneGroupSectionInterface : public UMovieSceneSection
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieSceneGroupSectionInterface">();
	}
	static class UMovieSceneGroupSectionInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieSceneGroupSectionInterface>();
	}
};
static_assert(alignof(UMovieSceneGroupSectionInterface) == 0x000008, "Wrong alignment on UMovieSceneGroupSectionInterface");
static_assert(sizeof(UMovieSceneGroupSectionInterface) == 0x000120, "Wrong size on UMovieSceneGroupSectionInterface");
...
static_assert(sizeof(UMovieSceneBindingLifetimeSection) == 0x000128, "Wrong size on UMovieSceneBindingLifetimeSection");
...
{
public:
	bool                                          DefaultValue;                                      // 0x0120(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x0128(0x0108)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneBoolSection) == 0x000230, "Wrong size on UMovieSceneBoolSection");
static_assert(offsetof(UMovieSceneBoolSection, DefaultValue) == 0x000120, "Member 'UMovieSceneBoolSection::DefaultValue' has a wrong offset!");
static_assert(offsetof(UMovieSceneBoolSection, BoolCurve) == 0x000128, "Member 'UMovieSceneBoolSection::BoolCurve' has a wrong offset!");
...
public:
	...
	uint8                                         bRequiresRangedHook : 1;                           // 0x0130(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRequiresTriggerHooks : 1;                         // 0x0130(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(sizeof(UMovieSceneHookSection) == 0x000138, "Wrong size on UMovieSceneHookSection");
...
static_assert(sizeof(UMovieSceneSpawnSection) == 0x000238, "Wrong size on UMovieSceneSpawnSection");
...
public:
	...
	struct FMovieSceneSectionParameters           Parameters;                                        // 0x0128(0x0028)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	...
	class UMovieSceneSequence*                    SubSequence;                                       // 0x0160(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UMovieSceneSubSection, Parameters) == 0x000128, "Member 'UMovieSceneSubSection::Parameters' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, StartOffset) == 0x000150, "Member 'UMovieSceneSubSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TimeScale) == 0x000154, "Member 'UMovieSceneSubSection::TimeScale' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, PrerollTime_MovieSceneSubSection) == 0x000158, "Member 'UMovieSceneSubSection::PrerollTime_MovieSceneSubSection' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, NetworkMask) == 0x00015C, "Member 'UMovieSceneSubSection::NetworkMask' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, SubSequence) == 0x000160, "Member 'UMovieSceneSubSection::SubSequence' has a wrong offset!");
...
static_assert(sizeof(UTestMovieSceneSection) == 0x000120, "Wrong size on UTestMovieSceneSection");
...
static_assert(sizeof(UTestMovieSceneEvalHookSection) == 0x000150, "Wrong size on UTestMovieSceneEvalHookSection");
