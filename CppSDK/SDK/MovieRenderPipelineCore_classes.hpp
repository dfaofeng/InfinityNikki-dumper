...
static_assert(sizeof(UMovieGraphBurnInWidget) == 0x0002F0, "Wrong size on UMovieGraphBurnInWidget");
...
static_assert(sizeof(AMoviePipelineGameMode) == 0x000448, "Wrong size on AMoviePipelineGameMode");
...
static_assert(sizeof(UMovieRenderDebugWidget) == 0x0002F0, "Wrong size on UMovieRenderDebugWidget");
...
static_assert(sizeof(UMovieGraphRenderPreviewWidget) == 0x0002F0, "Wrong size on UMovieGraphRenderPreviewWidget");
...
public:
	...
	TMulticastInlineDelegate<void(class ALevelSequenceActor* SequenceActor)> OnMoviePipelineLevelSequenceActorInitializedDelegate; // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bCustomInitializeFinished;                         // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldTransitionToProducingFramesState;           // 0x0099(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9A[0x6];                                       // 0x009A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UMoviePipelineCustomTimeStep*           CustomTimeStep;                                    // 0x00A0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A8[0x10];                                      // 0x00A8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UEngineCustomTimeStep*                  CachedPrevCustomTimeStep;                          // 0x00B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ULevelSequence*                         TargetSequence;                                    // 0x00C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x00C8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieRenderDebugWidget*                DebugWidget;                                       // 0x00D0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UTexture*                               PreviewTexture;                                    // 0x00D8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_E0[0x260];                                     // 0x00E0(0x0260)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void OnMoviePipelineFinishedImpl();
	void SetCustomInitializeFinished(bool bInCustomInitializeFinished);
	void SetInitializationTime(const struct FDateTime& InDateTime);
...
static_assert(offsetof(UMoviePipeline, OnMoviePipelineLevelSequenceActorInitializedDelegate) == 0x000088, "Member 'UMoviePipeline::OnMoviePipelineLevelSequenceActorInitializedDelegate' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, bCustomInitializeFinished) == 0x000098, "Member 'UMoviePipeline::bCustomInitializeFinished' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, bShouldTransitionToProducingFramesState) == 0x000099, "Member 'UMoviePipeline::bShouldTransitionToProducingFramesState' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, CustomTimeStep) == 0x0000A0, "Member 'UMoviePipeline::CustomTimeStep' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, CachedPrevCustomTimeStep) == 0x0000B8, "Member 'UMoviePipeline::CachedPrevCustomTimeStep' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, TargetSequence) == 0x0000C0, "Member 'UMoviePipeline::TargetSequence' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, LevelSequenceActor) == 0x0000C8, "Member 'UMoviePipeline::LevelSequenceActor' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, DebugWidget) == 0x0000D0, "Member 'UMoviePipeline::DebugWidget' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, PreviewTexture) == 0x0000D8, "Member 'UMoviePipeline::PreviewTexture' has a wrong offset!");
