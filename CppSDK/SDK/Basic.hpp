...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0A9D59A0;
	constexpr int32 AppendString      = 0x0095B930;
	constexpr int32 GNames            = 0x0A914080;
	constexpr int32 GWorld            = 0x0AB84288;
	constexpr int32 ProcessEvent      = 0x00B7D570;
