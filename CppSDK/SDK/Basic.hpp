...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0A64DCF0;
	constexpr int32 AppendString      = 0x00955390;
	constexpr int32 GNames            = 0x0A58C400;
	constexpr int32 GWorld            = 0x0A7F8238;
	constexpr int32 ProcessEvent      = 0x00B6EF30;
