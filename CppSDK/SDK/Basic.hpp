...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0AA24DB0;
	constexpr int32 AppendString      = 0x00968FC0;
	constexpr int32 GNames            = 0x0A963500;
	constexpr int32 GWorld            = 0x0A6ADDD0;
	constexpr int32 ProcessEvent      = 0x00B82F60;
