...
{
public:
	class UImagePlateComponent*                   ImagePlate;                                        // 0x03A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AImagePlate) == 0x0003B0, "Wrong size on AImagePlate");
static_assert(offsetof(AImagePlate, ImagePlate) == 0x0003A8, "Member 'AImagePlate::ImagePlate' has a wrong offset!");
...
{
public:
	struct FImagePlateParameters                  Plate;                                             // 0x05B8(0x0048)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_600[0x110];                                    // 0x0600(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UImagePlateComponent) == 0x000710, "Wrong size on UImagePlateComponent");
static_assert(offsetof(UImagePlateComponent, Plate) == 0x0005B8, "Member 'UImagePlateComponent::Plate' has a wrong offset!");
...
static_assert(sizeof(UImagePlateFrustumComponent) == 0x0005C0, "Wrong size on UImagePlateFrustumComponent");
