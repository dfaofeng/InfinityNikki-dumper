...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"TOD_NvWangYiji01_Dusk_C">();
	}
	static class UTOD_NvWangYiji01_Dusk_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTOD_NvWangYiji01_Dusk_C>();
	}
};
