...
// Function PrefabricatorRuntime.PrefabricatorBlueprintLibrary.GetStaticMeshFromPrefab
// 0x0028 (0x0028 - 0x0000)
struct PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab final
{
public:
	class UPrefabricatorAssetInterface*           PrefabricatorAssetInterface;                       // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FTransform>                     OutTransform;                                      // 0x0008(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FSoftObjectPath>                OutAssetReference;                                 // 0x0018(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab) == 0x000008, "Wrong alignment on PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab");
static_assert(sizeof(PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab) == 0x000028, "Wrong size on PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab");
static_assert(offsetof(PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab, PrefabricatorAssetInterface) == 0x000000, "Member 'PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab::PrefabricatorAssetInterface' has a wrong offset!");
static_assert(offsetof(PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab, OutTransform) == 0x000008, "Member 'PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab::OutTransform' has a wrong offset!");
static_assert(offsetof(PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab, OutAssetReference) == 0x000018, "Member 'PrefabricatorBlueprintLibrary_GetStaticMeshFromPrefab::OutAssetReference' has a wrong offset!");
...
// Function PrefabricatorRuntime.PrefabricatorBlueprintLibrary.UnpackPrefabricatorActorDatas
// 0x0020 (0x0020 - 0x0000)
struct PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas final
{
public:
	class UPrefabricatorAssetInterface*           PrefabricatorAssetInterface;                       // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FUnpackPrefabricatorActorData>  OutActorDatas;                                     // 0x0008(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0018(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas) == 0x000008, "Wrong alignment on PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas");
static_assert(sizeof(PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas) == 0x000020, "Wrong size on PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas");
static_assert(offsetof(PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas, PrefabricatorAssetInterface) == 0x000000, "Member 'PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas::PrefabricatorAssetInterface' has a wrong offset!");
static_assert(offsetof(PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas, OutActorDatas) == 0x000008, "Member 'PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas::OutActorDatas' has a wrong offset!");
static_assert(offsetof(PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas, ReturnValue) == 0x000018, "Member 'PrefabricatorBlueprintLibrary_UnpackPrefabricatorActorDatas::ReturnValue' has a wrong offset!");
