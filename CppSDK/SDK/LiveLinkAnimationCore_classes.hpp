...
{
public:
	class ULiveLinkRetargetAsset*                 CurrentRetargetAsset;                              // 0x03C8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULiveLinkInstance) == 0x0003D0, "Wrong size on ULiveLinkInstance");
static_assert(offsetof(ULiveLinkInstance, CurrentRetargetAsset) == 0x0003C8, "Member 'ULiveLinkInstance::CurrentRetargetAsset' has a wrong offset!");
