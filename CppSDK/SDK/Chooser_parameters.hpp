...
struct ChooserFunctionLibrary_EvaluateSoftChooser final
{
public:
	const class UObject*                          ContextObject;                                     // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	const class UChooserTable*                    ChooserTable;                                      // 0x0008(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(ChooserFunctionLibrary_EvaluateSoftChooser) == 0x000008, "Wrong alignment on ChooserFunctionLibrary_EvaluateSoftChooser");
static_assert(sizeof(ChooserFunctionLibrary_EvaluateSoftChooser) == 0x000040, "Wrong size on ChooserFunctionLibrary_EvaluateSoftChooser");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftChooser, ContextObject) == 0x000000, "Member 'ChooserFunctionLibrary_EvaluateSoftChooser::ContextObject' has a wrong offset!");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftChooser, ChooserTable) == 0x000008, "Member 'ChooserFunctionLibrary_EvaluateSoftChooser::ChooserTable' has a wrong offset!");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftChooser, ObjectClass) == 0x000010, "Member 'ChooserFunctionLibrary_EvaluateSoftChooser::ObjectClass' has a wrong offset!");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftChooser, ReturnValue) == 0x000018, "Member 'ChooserFunctionLibrary_EvaluateSoftChooser::ReturnValue' has a wrong offset!");

// Function Chooser.ChooserFunctionLibrary.EvaluateSoftObjectChooserBase
// 0x00C0 (0x00C0 - 0x0000)
struct ChooserFunctionLibrary_EvaluateSoftObjectChooserBase final
{
public:
	struct FChooserEvaluationContext              Context;                                           // 0x0000(0x0078)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FInstancedStruct                       ObjectChooser;                                     // 0x0078(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
static_assert(alignof(ChooserFunctionLibrary_EvaluateSoftObjectChooserBase) == 0x000008, "Wrong alignment on ChooserFunctionLibrary_EvaluateSoftObjectChooserBase");
static_assert(sizeof(ChooserFunctionLibrary_EvaluateSoftObjectChooserBase) == 0x0000C0, "Wrong size on ChooserFunctionLibrary_EvaluateSoftObjectChooserBase");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftObjectChooserBase, Context) == 0x000000, "Member 'ChooserFunctionLibrary_EvaluateSoftObjectChooserBase::Context' has a wrong offset!");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftObjectChooserBase, ObjectChooser) == 0x000078, "Member 'ChooserFunctionLibrary_EvaluateSoftObjectChooserBase::ObjectChooser' has a wrong offset!");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftObjectChooserBase, ObjectClass) == 0x000088, "Member 'ChooserFunctionLibrary_EvaluateSoftObjectChooserBase::ObjectClass' has a wrong offset!");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftObjectChooserBase, bResultIsClass) == 0x000090, "Member 'ChooserFunctionLibrary_EvaluateSoftObjectChooserBase::bResultIsClass' has a wrong offset!");
static_assert(offsetof(ChooserFunctionLibrary_EvaluateSoftObjectChooserBase, ReturnValue) == 0x000098, "Member 'ChooserFunctionLibrary_EvaluateSoftObjectChooserBase::ReturnValue' has a wrong offset!");
