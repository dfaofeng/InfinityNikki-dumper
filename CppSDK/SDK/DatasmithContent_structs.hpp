...
public:
	...
	TMap<class FName, uint32>                     StaticIntParameters;                               // 0x0050(0x0050)(NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FDatasmithStaticParameterSetTemplate) == 0x0000A0, "Wrong size on FDatasmithStaticParameterSetTemplate");
...
static_assert(offsetof(FDatasmithStaticParameterSetTemplate, StaticIntParameters) == 0x000050, "Member 'FDatasmithStaticParameterSetTemplate::StaticIntParameters' has a wrong offset!");
