...
struct WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem final
{
public:
...
static_assert(alignof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem) == 0x000008, "Wrong alignment on WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem");
static_assert(sizeof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem) == 0x000030, "Wrong size on WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem");
static_assert(offsetof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem, EntryPoint) == 0x000000, "Member 'WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem::EntryPoint' has a wrong offset!");
static_assert(offsetof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem, K2Node_Event_bIsExpanded) == 0x000004, "Member 'WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem::K2Node_Event_bIsExpanded' has a wrong offset!");
static_assert(offsetof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem, K2Node_Event_bIsSelected) == 0x000005, "Member 'WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem::K2Node_Event_bIsSelected' has a wrong offset!");
static_assert(offsetof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem, K2Node_Event_index_1) == 0x000008, "Member 'WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem::K2Node_Event_index_1' has a wrong offset!");
static_assert(offsetof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem, K2Node_Event_index) == 0x00000C, "Member 'WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem, CallFunc_PlayAnimation_ReturnValue) == 0x000010, "Member 'WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem, CallFunc_PlayAnimation_ReturnValue_1) == 0x000018, "Member 'WBP_System_EntryItem_C_ExecuteUbergraph_WBP_System_EntryItem::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
...
struct WBP_System_EntryItem_C_GetModuleName final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
};
static_assert(alignof(WBP_System_EntryItem_C_GetModuleName) == 0x000008, "Wrong alignment on WBP_System_EntryItem_C_GetModuleName");
static_assert(sizeof(WBP_System_EntryItem_C_GetModuleName) == 0x000010, "Wrong size on WBP_System_EntryItem_C_GetModuleName");
static_assert(offsetof(WBP_System_EntryItem_C_GetModuleName, ReturnValue) == 0x000000, "Member 'WBP_System_EntryItem_C_GetModuleName::ReturnValue' has a wrong offset!");
