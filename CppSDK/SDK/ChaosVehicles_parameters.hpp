...
// Function ChaosVehicles.ChaosWheeledVehicleMovementComponent.GetNumWheelsOnGround
// 0x0004 (0x0004 - 0x0000)
struct ChaosWheeledVehicleMovementComponent_GetNumWheelsOnGround final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ChaosWheeledVehicleMovementComponent_GetNumWheelsOnGround) == 0x000004, "Wrong alignment on ChaosWheeledVehicleMovementComponent_GetNumWheelsOnGround");
static_assert(sizeof(ChaosWheeledVehicleMovementComponent_GetNumWheelsOnGround) == 0x000004, "Wrong size on ChaosWheeledVehicleMovementComponent_GetNumWheelsOnGround");
static_assert(offsetof(ChaosWheeledVehicleMovementComponent_GetNumWheelsOnGround, ReturnValue) == 0x000000, "Member 'ChaosWheeledVehicleMovementComponent_GetNumWheelsOnGround::ReturnValue' has a wrong offset!");
...
// Function ChaosVehicles.ChaosWheeledVehicleMovementComponent.IsAllWheelsOnGround
// 0x0001 (0x0001 - 0x0000)
struct ChaosWheeledVehicleMovementComponent_IsAllWheelsOnGround final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ChaosWheeledVehicleMovementComponent_IsAllWheelsOnGround) == 0x000001, "Wrong alignment on ChaosWheeledVehicleMovementComponent_IsAllWheelsOnGround");
static_assert(sizeof(ChaosWheeledVehicleMovementComponent_IsAllWheelsOnGround) == 0x000001, "Wrong size on ChaosWheeledVehicleMovementComponent_IsAllWheelsOnGround");
static_assert(offsetof(ChaosWheeledVehicleMovementComponent_IsAllWheelsOnGround, ReturnValue) == 0x000000, "Member 'ChaosWheeledVehicleMovementComponent_IsAllWheelsOnGround::ReturnValue' has a wrong offset!");
