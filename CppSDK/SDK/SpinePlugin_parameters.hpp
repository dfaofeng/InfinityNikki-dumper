...
// Function SpinePlugin.SpineSkeletonRendererComponent.ReplaceAttachmentTexture
// 0x0018 (0x0018 - 0x0000)
struct SpineSkeletonRendererComponent_ReplaceAttachmentTexture final
{
public:
...
static_assert(alignof(SpineSkeletonRendererComponent_ReplaceAttachmentTexture) == 0x000008, "Wrong alignment on SpineSkeletonRendererComponent_ReplaceAttachmentTexture");
static_assert(sizeof(SpineSkeletonRendererComponent_ReplaceAttachmentTexture) == 0x000018, "Wrong size on SpineSkeletonRendererComponent_ReplaceAttachmentTexture");
static_assert(offsetof(SpineSkeletonRendererComponent_ReplaceAttachmentTexture, SlotName) == 0x000000, "Member 'SpineSkeletonRendererComponent_ReplaceAttachmentTexture::SlotName' has a wrong offset!");
static_assert(offsetof(SpineSkeletonRendererComponent_ReplaceAttachmentTexture, Texture) == 0x000010, "Member 'SpineSkeletonRendererComponent_ReplaceAttachmentTexture::Texture' has a wrong offset!");

// Function SpinePlugin.SpineSkeletonRendererComponent.ResetAttachment
// 0x0010 (0x0010 - 0x0000)
struct SpineSkeletonRendererComponent_ResetAttachment final
{
public:
	class FString                                 SlotName;                                          // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SpineSkeletonRendererComponent_ResetAttachment) == 0x000008, "Wrong alignment on SpineSkeletonRendererComponent_ResetAttachment");
static_assert(sizeof(SpineSkeletonRendererComponent_ResetAttachment) == 0x000010, "Wrong size on SpineSkeletonRendererComponent_ResetAttachment");
static_assert(offsetof(SpineSkeletonRendererComponent_ResetAttachment, SlotName) == 0x000000, "Member 'SpineSkeletonRendererComponent_ResetAttachment::SlotName' has a wrong offset!");
...
// Function SpinePlugin.SpineWidget.AddTransformOffset
// 0x0010 (0x0010 - 0x0000)
struct SpineWidget_AddTransformOffset final
{
public:
...
static_assert(alignof(SpineWidget_AddTransformOffset) == 0x000008, "Wrong alignment on SpineWidget_AddTransformOffset");
static_assert(sizeof(SpineWidget_AddTransformOffset) == 0x000010, "Wrong size on SpineWidget_AddTransformOffset");
static_assert(offsetof(SpineWidget_AddTransformOffset, Offset) == 0x000000, "Member 'SpineWidget_AddTransformOffset::Offset' has a wrong offset!");
...
// Function SpinePlugin.SpineWidget.ReplaceAttachmentTexture
// 0x0018 (0x0018 - 0x0000)
struct SpineWidget_ReplaceAttachmentTexture final
{
public:
	class FString                                 SlotName;                                          // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             Texture;                                           // 0x0010(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SpineWidget_ReplaceAttachmentTexture) == 0x000008, "Wrong alignment on SpineWidget_ReplaceAttachmentTexture");
static_assert(sizeof(SpineWidget_ReplaceAttachmentTexture) == 0x000018, "Wrong size on SpineWidget_ReplaceAttachmentTexture");
static_assert(offsetof(SpineWidget_ReplaceAttachmentTexture, SlotName) == 0x000000, "Member 'SpineWidget_ReplaceAttachmentTexture::SlotName' has a wrong offset!");
static_assert(offsetof(SpineWidget_ReplaceAttachmentTexture, Texture) == 0x000010, "Member 'SpineWidget_ReplaceAttachmentTexture::Texture' has a wrong offset!");

// Function SpinePlugin.SpineWidget.ResetAttachment
// 0x0010 (0x0010 - 0x0000)
struct SpineWidget_ResetAttachment final
{
public:
	class FString                                 SlotName;                                          // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SpineWidget_ResetAttachment) == 0x000008, "Wrong alignment on SpineWidget_ResetAttachment");
static_assert(sizeof(SpineWidget_ResetAttachment) == 0x000010, "Wrong size on SpineWidget_ResetAttachment");
static_assert(offsetof(SpineWidget_ResetAttachment, SlotName) == 0x000000, "Member 'SpineWidget_ResetAttachment::SlotName' has a wrong offset!");
...
// Function SpinePlugin.SpineWidget.SetAsset
// 0x0018 (0x0018 - 0x0000)
struct SpineWidget_SetAsset final
{
public:
	class USpineAtlasAsset*                       InAtlas;                                           // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USpineSkeletonDataAsset*                InSkeletonData;                                    // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bKeepOffset;                                       // 0x0010(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(SpineWidget_SetAsset) == 0x000008, "Wrong alignment on SpineWidget_SetAsset");
static_assert(sizeof(SpineWidget_SetAsset) == 0x000018, "Wrong size on SpineWidget_SetAsset");
static_assert(offsetof(SpineWidget_SetAsset, InAtlas) == 0x000000, "Member 'SpineWidget_SetAsset::InAtlas' has a wrong offset!");
static_assert(offsetof(SpineWidget_SetAsset, InSkeletonData) == 0x000008, "Member 'SpineWidget_SetAsset::InSkeletonData' has a wrong offset!");
static_assert(offsetof(SpineWidget_SetAsset, bKeepOffset) == 0x000010, "Member 'SpineWidget_SetAsset::bKeepOffset' has a wrong offset!");
...
// 0x0010 (0x0010 - 0x0000)
struct SpineWidget_SetColor final
{
public:
...
static_assert(alignof(SpineWidget_SetColor) == 0x000004, "Wrong alignment on SpineWidget_SetColor");
static_assert(sizeof(SpineWidget_SetColor) == 0x000010, "Wrong size on SpineWidget_SetColor");
static_assert(offsetof(SpineWidget_SetColor, InColorAndOpacity) == 0x000000, "Member 'SpineWidget_SetColor::InColorAndOpacity' has a wrong offset!");
...
// Function SpinePlugin.SpineWidget.SetTransformOffset
// 0x0010 (0x0010 - 0x0000)
struct SpineWidget_SetTransformOffset final
{
public:
	struct FVector2D                              Offset;                                            // 0x0000(0x0010)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SpineWidget_SetTransformOffset) == 0x000008, "Wrong alignment on SpineWidget_SetTransformOffset");
static_assert(sizeof(SpineWidget_SetTransformOffset) == 0x000010, "Wrong size on SpineWidget_SetTransformOffset");
static_assert(offsetof(SpineWidget_SetTransformOffset, Offset) == 0x000000, "Member 'SpineWidget_SetTransformOffset::Offset' has a wrong offset!");
