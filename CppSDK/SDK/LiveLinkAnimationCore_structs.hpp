...
{
public:
	struct FAnimNode_LiveLinkPose                 PoseNode;                                          // 0x0748(0x0068)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLiveLinkInstanceProxy) == 0x000010, "Wrong alignment on FLiveLinkInstanceProxy");
static_assert(sizeof(FLiveLinkInstanceProxy) == 0x0007B0, "Wrong size on FLiveLinkInstanceProxy");
static_assert(offsetof(FLiveLinkInstanceProxy, PoseNode) == 0x000748, "Member 'FLiveLinkInstanceProxy::PoseNode' has a wrong offset!");
