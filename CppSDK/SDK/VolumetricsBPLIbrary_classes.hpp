...
public:
	...
	static void PseudoVolume_Dimensions(uint8 Dimensions, class UObject* __WorldContext, struct FIntPoint* RT_Size, struct FIntPoint* XY_Frames, int32* Volume_Size);
...
static_assert(sizeof(UVolumetricsBPLIbrary_C) == 0x000028, "Wrong size on UVolumetricsBPLIbrary_C");
