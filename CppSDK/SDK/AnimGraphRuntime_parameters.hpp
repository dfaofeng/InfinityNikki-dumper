...
// Function AnimGraphRuntime.AnimationStateMachineLibrary.ClearActiveTransitions
// 0x0020 (0x0020 - 0x0000)
struct AnimationStateMachineLibrary_ClearActiveTransitions final
{
public:
...
static_assert(alignof(AnimationStateMachineLibrary_ClearActiveTransitions) == 0x000008, "Wrong alignment on AnimationStateMachineLibrary_ClearActiveTransitions");
static_assert(sizeof(AnimationStateMachineLibrary_ClearActiveTransitions) == 0x000020, "Wrong size on AnimationStateMachineLibrary_ClearActiveTransitions");
static_assert(offsetof(AnimationStateMachineLibrary_ClearActiveTransitions, UpdateContext) == 0x000000, "Member 'AnimationStateMachineLibrary_ClearActiveTransitions::UpdateContext' has a wrong offset!");
static_assert(offsetof(AnimationStateMachineLibrary_ClearActiveTransitions, Node) == 0x000010, "Member 'AnimationStateMachineLibrary_ClearActiveTransitions::Node' has a wrong offset!");
...
static_assert(offsetof(PlayMontageCallbackProxy_CreateProxyObjectForPlayMontage, bMirror) == 0x000020, "Member 'PlayMontageCallbackProxy_CreateProxyObjectForPlayMontage::bMirror' has a wrong offset!");
...
// Function AnimGraphRuntime.SequencePlayerLibrary.X6SetAccumulatedTime
// 0x0030 (0x0030 - 0x0000)
struct SequencePlayerLibrary_X6SetAccumulatedTime final
{
public:
	struct FSequencePlayerReference               SequencePlayer;                                    // 0x0000(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	float                                         Time;                                              // 0x0010(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFireNotifies;                                     // 0x0014(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimInstance*                          AnimInstance;                                      // 0x0018(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSequencePlayerReference               ReturnValue;                                       // 0x0020(0x0010)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(SequencePlayerLibrary_X6SetAccumulatedTime) == 0x000008, "Wrong alignment on SequencePlayerLibrary_X6SetAccumulatedTime");
static_assert(sizeof(SequencePlayerLibrary_X6SetAccumulatedTime) == 0x000030, "Wrong size on SequencePlayerLibrary_X6SetAccumulatedTime");
static_assert(offsetof(SequencePlayerLibrary_X6SetAccumulatedTime, SequencePlayer) == 0x000000, "Member 'SequencePlayerLibrary_X6SetAccumulatedTime::SequencePlayer' has a wrong offset!");
static_assert(offsetof(SequencePlayerLibrary_X6SetAccumulatedTime, Time) == 0x000010, "Member 'SequencePlayerLibrary_X6SetAccumulatedTime::Time' has a wrong offset!");
static_assert(offsetof(SequencePlayerLibrary_X6SetAccumulatedTime, bFireNotifies) == 0x000014, "Member 'SequencePlayerLibrary_X6SetAccumulatedTime::bFireNotifies' has a wrong offset!");
static_assert(offsetof(SequencePlayerLibrary_X6SetAccumulatedTime, AnimInstance) == 0x000018, "Member 'SequencePlayerLibrary_X6SetAccumulatedTime::AnimInstance' has a wrong offset!");
static_assert(offsetof(SequencePlayerLibrary_X6SetAccumulatedTime, ReturnValue) == 0x000020, "Member 'SequencePlayerLibrary_X6SetAccumulatedTime::ReturnValue' has a wrong offset!");
