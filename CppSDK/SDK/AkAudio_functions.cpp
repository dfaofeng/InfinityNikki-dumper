...
// (Final, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// const class FString&                    LanguageName                                           (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

float UAkAudioEvent::GetLocalizedMaximumDuration(const class FString& LanguageName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AkAudioEvent", "GetLocalizedMaximumDuration");

	Params::AkAudioEvent_GetLocalizedMaximumDuration Parms{};

	Parms.LanguageName = std::move(LanguageName);
...
class UAkComponent* UAkGameplayStatics::GetSpatialAudioListener()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "GetSpatialAudioListener");

	Params::AkGameplayStatics_GetSpatialAudioListener Parms{};
