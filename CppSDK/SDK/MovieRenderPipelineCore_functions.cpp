...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInCustomInitializeFinished                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMoviePipeline::SetCustomInitializeFinished(bool bInCustomInitializeFinished)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MoviePipeline", "SetCustomInitializeFinished");

	Params::MoviePipeline_SetCustomInitializeFinished Parms{};

	Parms.bInCustomInitializeFinished = bInCustomInitializeFinished;
