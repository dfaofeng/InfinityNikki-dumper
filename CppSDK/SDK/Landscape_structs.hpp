...
// Enum Landscape.ELayerWeightCollisionMask
// NumValues: 0x0004
enum class ELayerWeightCollisionMask : uint8
{
	Default                                  = 0,
	Ignore                                   = 1,
	Override                                 = 2,
	ELayerWeightCollisionMask_MAX            = 3,
};
...
public:
	...
	bool                                          bReplaced;                                         // 0x001A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FLandscapeLayer, bReplaced) == 0x00001A, "Member 'FLandscapeLayer::bReplaced' has a wrong offset!");
...
public:
	...
	struct FVector                                GrassMeshScale;                                    // 0x0008(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UStaticMesh*                            ReplaceTargetMesh;                                 // 0x0020(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             ReplaceMeshOffsetTransform;                        // 0x0030(0x0060)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UMaterialInterface*>             OverrideMaterials;                                 // 0x0090(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	struct FPerPlatformFloat                      GrassDensity;                                      // 0x00A0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bUsePaperCustomData : 1;                           // 0x00A4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         PaperCustomData;                                   // 0x00A5(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A6[0x2];                                       // 0x00A6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPerQualityLevelFloat                  GrassDensityQuality;                               // 0x00A8(0x0068)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	bool                                          bUseGrid;                                          // 0x0110(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_111[0x3];                                      // 0x0111(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PlacementJitter;                                   // 0x0114(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPerPlatformInt                        StartCullDistance;                                 // 0x0118(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_11C[0x4];                                      // 0x011C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPerQualityLevelInt                    StartCullDistanceQuality;                          // 0x0120(0x0068)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FPerPlatformInt                        EndCullDistance;                                   // 0x0188(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_18C[0x4];                                      // 0x018C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPerQualityLevelInt                    EndCullDistanceQuality;                            // 0x0190(0x0068)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	int32                                         MinLOD;                                            // 0x01F8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGrassScaling                                 Scaling;                                           // 0x01FC(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1FD[0x3];                                      // 0x01FD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFloatInterval                         ScaleX;                                            // 0x0200(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFloatInterval                         ScaleY;                                            // 0x0208(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFloatInterval                         ScaleZ;                                            // 0x0210(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWeightAttenuatesMaxScale;                         // 0x0218(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_219[0x3];                                      // 0x0219(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxScaleWeightAttenuation;                         // 0x021C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          RandomRotation;                                    // 0x0220(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AlignToSurface;                                    // 0x0221(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseLandscapeLightmap;                             // 0x0222(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLightingChannels                      LightingChannels;                                  // 0x0223(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	bool                                          bReceivesDecals;                                   // 0x0224(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERenderInHeightfieldReadbackStats             RenderInHeightfieldReadbackStats;                  // 0x0225(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAffectDistanceFieldLighting;                      // 0x0226(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCastDynamicShadow;                                // 0x0227(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCastContactShadow;                                // 0x0228(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bKeepInstanceBufferCPUCopy;                        // 0x0229(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_22A[0x2];                                      // 0x022A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        InstanceWorldPositionOffsetDisableDistance;        // 0x022C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class URuntimeVirtualTexture*>         RuntimeVirtualTextures;                            // 0x0230(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	int8                                          VirtualTextureLodBias;                             // 0x0240(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int8                                          VirtualTextureCullMips;                            // 0x0241(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int8                                          VirtualTextureMinCoverage;                         // 0x0242(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERuntimeVirtualTextureMainPassType            VirtualTextureRenderPassType;                      // 0x0243(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bRenderInStreamingVirtualTextureOnly : 1;          // 0x0244(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	EShadowCacheInvalidationBehavior              ShadowCacheInvalidationBehavior;                   // 0x0245(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_246[0xA];                                      // 0x0246(0x000A)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGrassVariety) == 0x000010, "Wrong alignment on FGrassVariety");
static_assert(sizeof(FGrassVariety) == 0x000250, "Wrong size on FGrassVariety");
static_assert(offsetof(FGrassVariety, GrassMesh) == 0x000000, "Member 'FGrassVariety::GrassMesh' has a wrong offset!");
static_assert(offsetof(FGrassVariety, GrassMeshScale) == 0x000008, "Member 'FGrassVariety::GrassMeshScale' has a wrong offset!");
static_assert(offsetof(FGrassVariety, ReplaceTargetMesh) == 0x000020, "Member 'FGrassVariety::ReplaceTargetMesh' has a wrong offset!");
static_assert(offsetof(FGrassVariety, ReplaceMeshOffsetTransform) == 0x000030, "Member 'FGrassVariety::ReplaceMeshOffsetTransform' has a wrong offset!");
static_assert(offsetof(FGrassVariety, OverrideMaterials) == 0x000090, "Member 'FGrassVariety::OverrideMaterials' has a wrong offset!");
static_assert(offsetof(FGrassVariety, GrassDensity) == 0x0000A0, "Member 'FGrassVariety::GrassDensity' has a wrong offset!");
static_assert(offsetof(FGrassVariety, PaperCustomData) == 0x0000A5, "Member 'FGrassVariety::PaperCustomData' has a wrong offset!");
static_assert(offsetof(FGrassVariety, GrassDensityQuality) == 0x0000A8, "Member 'FGrassVariety::GrassDensityQuality' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bUseGrid) == 0x000110, "Member 'FGrassVariety::bUseGrid' has a wrong offset!");
static_assert(offsetof(FGrassVariety, PlacementJitter) == 0x000114, "Member 'FGrassVariety::PlacementJitter' has a wrong offset!");
static_assert(offsetof(FGrassVariety, StartCullDistance) == 0x000118, "Member 'FGrassVariety::StartCullDistance' has a wrong offset!");
static_assert(offsetof(FGrassVariety, StartCullDistanceQuality) == 0x000120, "Member 'FGrassVariety::StartCullDistanceQuality' has a wrong offset!");
static_assert(offsetof(FGrassVariety, EndCullDistance) == 0x000188, "Member 'FGrassVariety::EndCullDistance' has a wrong offset!");
static_assert(offsetof(FGrassVariety, EndCullDistanceQuality) == 0x000190, "Member 'FGrassVariety::EndCullDistanceQuality' has a wrong offset!");
static_assert(offsetof(FGrassVariety, MinLOD) == 0x0001F8, "Member 'FGrassVariety::MinLOD' has a wrong offset!");
static_assert(offsetof(FGrassVariety, Scaling) == 0x0001FC, "Member 'FGrassVariety::Scaling' has a wrong offset!");
static_assert(offsetof(FGrassVariety, ScaleX) == 0x000200, "Member 'FGrassVariety::ScaleX' has a wrong offset!");
static_assert(offsetof(FGrassVariety, ScaleY) == 0x000208, "Member 'FGrassVariety::ScaleY' has a wrong offset!");
static_assert(offsetof(FGrassVariety, ScaleZ) == 0x000210, "Member 'FGrassVariety::ScaleZ' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bWeightAttenuatesMaxScale) == 0x000218, "Member 'FGrassVariety::bWeightAttenuatesMaxScale' has a wrong offset!");
static_assert(offsetof(FGrassVariety, MaxScaleWeightAttenuation) == 0x00021C, "Member 'FGrassVariety::MaxScaleWeightAttenuation' has a wrong offset!");
static_assert(offsetof(FGrassVariety, RandomRotation) == 0x000220, "Member 'FGrassVariety::RandomRotation' has a wrong offset!");
static_assert(offsetof(FGrassVariety, AlignToSurface) == 0x000221, "Member 'FGrassVariety::AlignToSurface' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bUseLandscapeLightmap) == 0x000222, "Member 'FGrassVariety::bUseLandscapeLightmap' has a wrong offset!");
static_assert(offsetof(FGrassVariety, LightingChannels) == 0x000223, "Member 'FGrassVariety::LightingChannels' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bReceivesDecals) == 0x000224, "Member 'FGrassVariety::bReceivesDecals' has a wrong offset!");
static_assert(offsetof(FGrassVariety, RenderInHeightfieldReadbackStats) == 0x000225, "Member 'FGrassVariety::RenderInHeightfieldReadbackStats' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bAffectDistanceFieldLighting) == 0x000226, "Member 'FGrassVariety::bAffectDistanceFieldLighting' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bCastDynamicShadow) == 0x000227, "Member 'FGrassVariety::bCastDynamicShadow' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bCastContactShadow) == 0x000228, "Member 'FGrassVariety::bCastContactShadow' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bKeepInstanceBufferCPUCopy) == 0x000229, "Member 'FGrassVariety::bKeepInstanceBufferCPUCopy' has a wrong offset!");
static_assert(offsetof(FGrassVariety, InstanceWorldPositionOffsetDisableDistance) == 0x00022C, "Member 'FGrassVariety::InstanceWorldPositionOffsetDisableDistance' has a wrong offset!");
static_assert(offsetof(FGrassVariety, RuntimeVirtualTextures) == 0x000230, "Member 'FGrassVariety::RuntimeVirtualTextures' has a wrong offset!");
static_assert(offsetof(FGrassVariety, VirtualTextureLodBias) == 0x000240, "Member 'FGrassVariety::VirtualTextureLodBias' has a wrong offset!");
static_assert(offsetof(FGrassVariety, VirtualTextureCullMips) == 0x000241, "Member 'FGrassVariety::VirtualTextureCullMips' has a wrong offset!");
static_assert(offsetof(FGrassVariety, VirtualTextureMinCoverage) == 0x000242, "Member 'FGrassVariety::VirtualTextureMinCoverage' has a wrong offset!");
static_assert(offsetof(FGrassVariety, VirtualTextureRenderPassType) == 0x000243, "Member 'FGrassVariety::VirtualTextureRenderPassType' has a wrong offset!");
static_assert(offsetof(FGrassVariety, ShadowCacheInvalidationBehavior) == 0x000245, "Member 'FGrassVariety::ShadowCacheInvalidationBehavior' has a wrong offset!");
...
public:
	...
	bool                                          DisturbZ;                                          // 0x0008(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FExpressionInput                       DisturbInput;                                      // 0x0010(0x0028)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	class ULandscapeGrassType*                    GrassType;                                         // 0x0038(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FExpressionInput                       Input;                                             // 0x0040(0x0028)(NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGrassInput) == 0x000008, "Wrong alignment on FGrassInput");
static_assert(sizeof(FGrassInput) == 0x000068, "Wrong size on FGrassInput");
static_assert(offsetof(FGrassInput, Name) == 0x000000, "Member 'FGrassInput::Name' has a wrong offset!");
static_assert(offsetof(FGrassInput, DisturbZ) == 0x000008, "Member 'FGrassInput::DisturbZ' has a wrong offset!");
