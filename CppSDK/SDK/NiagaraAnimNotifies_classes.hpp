...
public:
	...
	bool                                          bUseAttachParentBound;                             // 0x0072(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, bUseAttachParentBound) == 0x000072, "Member 'UAnimNotifyState_TimedNiagaraEffect::bUseAttachParentBound' has a wrong offset!");
...
public:
	...
	bool                                          bUseAttachParentBound;                             // 0x00CC(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAnimNotify_PlayNiagaraEffect, bUseAttachParentBound) == 0x0000CC, "Member 'UAnimNotify_PlayNiagaraEffect::bUseAttachParentBound' has a wrong offset!");
