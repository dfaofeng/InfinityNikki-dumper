...
public:
	...
	bool                                          bX6ForceControlRootmotion;                         // 0x0068(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bX6ForceEnableRootmotion;                          // 0x0069(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_BlendSpacePlayerBase) == 0x000070, "Wrong size on FAnimNode_BlendSpacePlayerBase");
...
static_assert(offsetof(FAnimNode_BlendSpacePlayerBase, bX6ForceControlRootmotion) == 0x000068, "Member 'FAnimNode_BlendSpacePlayerBase::bX6ForceControlRootmotion' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayerBase, bX6ForceEnableRootmotion) == 0x000069, "Member 'FAnimNode_BlendSpacePlayerBase::bX6ForceEnableRootmotion' has a wrong offset!");
...
{
public:
	class UBlendSpace*                            BlendSpace;                                        // 0x0070(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FAnimNode_BlendSpacePlayer) == 0x000008, "Wrong alignment on FAnimNode_BlendSpacePlayer");
static_assert(sizeof(FAnimNode_BlendSpacePlayer) == 0x000078, "Wrong size on FAnimNode_BlendSpacePlayer");
...
struct alignas(0x10) FAnimNode_AimOffsetLookAt : public FAnimNode_BlendSpacePlayer
{
public:
	...
	bool                                          bSkipUpdateLookAtTarget;                           // 0x0164(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_165[0x3];                                      // 0x0165(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                LookAtLocation;                                    // 0x0168(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SocketAxis;                                        // 0x0180(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         alpha;                                             // 0x0198(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, bSkipUpdateLookAtTarget) == 0x000164, "Member 'FAnimNode_AimOffsetLookAt::bSkipUpdateLookAtTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LookAtLocation) == 0x000168, "Member 'FAnimNode_AimOffsetLookAt::LookAtLocation' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, alpha) == 0x000198, "Member 'FAnimNode_AimOffsetLookAt::alpha' has a wrong offset!");
...
{
public:
	float                                         NormalizedTime;                                    // 0x0078(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTeleportToNormalizedTime;                         // 0x007C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_BlendSpaceEvaluator) == 0x000080, "Wrong size on FAnimNode_BlendSpaceEvaluator");
static_assert(offsetof(FAnimNode_BlendSpaceEvaluator, NormalizedTime) == 0x000078, "Member 'FAnimNode_BlendSpaceEvaluator::NormalizedTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpaceEvaluator, bTeleportToNormalizedTime) == 0x00007C, "Member 'FAnimNode_BlendSpaceEvaluator::bTeleportToNormalizedTime' has a wrong offset!");
...
{
public:
	class FName                                   GroupName;                                         // 0x0070(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EAnimGroupRole                                GroupRole;                                         // 0x0078(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EAnimSyncMethod                               Method;                                            // 0x0079(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIgnoreForRelevancyTest;                           // 0x007A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_7B[0x1];                                       // 0x007B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         X;                                                 // 0x007C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         Y;                                                 // 0x0080(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         PlayRate;                                          // 0x0084(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bLoop;                                             // 0x0088(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bResetPlayTimeWhenBlendSpaceChanges;               // 0x0089(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_8A[0x2];                                       // 0x008A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StartPosition;                                     // 0x008C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FAnimNode_BlendSpacePlayer_Standalone) == 0x000098, "Wrong size on FAnimNode_BlendSpacePlayer_Standalone");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, GroupName) == 0x000070, "Member 'FAnimNode_BlendSpacePlayer_Standalone::GroupName' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, GroupRole) == 0x000078, "Member 'FAnimNode_BlendSpacePlayer_Standalone::GroupRole' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, Method) == 0x000079, "Member 'FAnimNode_BlendSpacePlayer_Standalone::Method' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bIgnoreForRelevancyTest) == 0x00007A, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bIgnoreForRelevancyTest' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, X) == 0x00007C, "Member 'FAnimNode_BlendSpacePlayer_Standalone::X' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, Y) == 0x000080, "Member 'FAnimNode_BlendSpacePlayer_Standalone::Y' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, PlayRate) == 0x000084, "Member 'FAnimNode_BlendSpacePlayer_Standalone::PlayRate' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bLoop) == 0x000088, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bLoop' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bResetPlayTimeWhenBlendSpaceChanges) == 0x000089, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bResetPlayTimeWhenBlendSpaceChanges' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, StartPosition) == 0x00008C, "Member 'FAnimNode_BlendSpacePlayer_Standalone::StartPosition' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, BlendSpace) == 0x000090, "Member 'FAnimNode_BlendSpacePlayer_Standalone::BlendSpace' has a wrong offset!");
...
public:
	...
	bool                                          bResetCurveValueBeforePoseExtract;                 // 0x00B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_PoseBlendNode, bResetCurveValueBeforePoseExtract) == 0x0000B8, "Member 'FAnimNode_PoseBlendNode::bResetCurveValueBeforePoseExtract' has a wrong offset!");
...
{
public:
	struct FPoseLink                              BasePose;                                          // 0x0078(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpace) == 0x000120, "Wrong size on FAnimNode_RotationOffsetBlendSpace");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, BasePose) == 0x000078, "Member 'FAnimNode_RotationOffsetBlendSpace::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, LODThreshold) == 0x000088, "Member 'FAnimNode_RotationOffsetBlendSpace::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, alpha) == 0x00008C, "Member 'FAnimNode_RotationOffsetBlendSpace::alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBias) == 0x000090, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaBoolBlend) == 0x000098, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaCurveName) == 0x0000E0, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x0000E8, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x00011C, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x00011D, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
...
// 0x0460 (0x0BB0 - 0x0750)
struct FAnimSequencerInstanceProxy final : public FAnimInstanceProxy
{
public:
	uint8                                         Pad_748[0x468];                                    // 0x0748(0x0468)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
