...
public:
	...
	class UDynamicMesh*                           MeshObject;                                        // 0x0700(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOctreeDynamicMeshComponent) == 0x0007C0, "Wrong size on UOctreeDynamicMeshComponent");
static_assert(offsetof(UOctreeDynamicMeshComponent, MeshObject) == 0x000700, "Member 'UOctreeDynamicMeshComponent::MeshObject' has a wrong offset!");
...
{
public:
	class UMaterialInterface*                     LineMaterial;                                      // 0x0640(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ULineSetComponent) == 0x0006C0, "Wrong size on ULineSetComponent");
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x000640, "Member 'ULineSetComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, Bounds) == 0x000648, "Member 'ULineSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, bBoundsDirty) == 0x000680, "Member 'ULineSetComponent::bBoundsDirty' has a wrong offset!");
...
public:
	...
	class UMaterialInterface*                     LineMaterial;                                      // 0x0698(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMeshWireframeComponent) == 0x0006F0, "Wrong size on UMeshWireframeComponent");
static_assert(offsetof(UMeshWireframeComponent, LineDepthBias) == 0x000640, "Member 'UMeshWireframeComponent::LineDepthBias' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LineDepthBiasSizeScale) == 0x000644, "Member 'UMeshWireframeComponent::LineDepthBiasSizeScale' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ThicknessScale) == 0x000648, "Member 'UMeshWireframeComponent::ThicknessScale' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableWireframe) == 0x00064C, "Member 'UMeshWireframeComponent::bEnableWireframe' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, WireframeColor) == 0x000650, "Member 'UMeshWireframeComponent::WireframeColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, WireframeThickness) == 0x000654, "Member 'UMeshWireframeComponent::WireframeThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableBoundaryEdges) == 0x000658, "Member 'UMeshWireframeComponent::bEnableBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeColor) == 0x00065C, "Member 'UMeshWireframeComponent::BoundaryEdgeColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeThickness) == 0x000660, "Member 'UMeshWireframeComponent::BoundaryEdgeThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableUVSeams) == 0x000664, "Member 'UMeshWireframeComponent::bEnableUVSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, UVSeamColor) == 0x000668, "Member 'UMeshWireframeComponent::UVSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, UVSeamThickness) == 0x00066C, "Member 'UMeshWireframeComponent::UVSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableNormalSeams) == 0x000670, "Member 'UMeshWireframeComponent::bEnableNormalSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, NormalSeamColor) == 0x000674, "Member 'UMeshWireframeComponent::NormalSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, NormalSeamThickness) == 0x000678, "Member 'UMeshWireframeComponent::NormalSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableTangentSeams) == 0x00067C, "Member 'UMeshWireframeComponent::bEnableTangentSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, TangentSeamColor) == 0x000680, "Member 'UMeshWireframeComponent::TangentSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, TangentSeamThickness) == 0x000684, "Member 'UMeshWireframeComponent::TangentSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableColorSeams) == 0x000688, "Member 'UMeshWireframeComponent::bEnableColorSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ColorSeamColor) == 0x00068C, "Member 'UMeshWireframeComponent::ColorSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ColorSeamThickness) == 0x000690, "Member 'UMeshWireframeComponent::ColorSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LineMaterial) == 0x000698, "Member 'UMeshWireframeComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LocalBounds) == 0x0006A0, "Member 'UMeshWireframeComponent::LocalBounds' has a wrong offset!");
...
{
public:
	class UMaterialInterface*                     PointMaterial;                                     // 0x0640(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FBoxSphereBounds                       Bounds;                                            // 0x0648(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bBoundsDirty;                                      // 0x0680(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_681[0x3F];                                     // 0x0681(0x003F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPointSetComponent) == 0x0006C0, "Wrong size on UPointSetComponent");
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x000640, "Member 'UPointSetComponent::PointMaterial' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, Bounds) == 0x000648, "Member 'UPointSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, bBoundsDirty) == 0x000680, "Member 'UPointSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(sizeof(APreviewGeometryActor) == 0x0003B0, "Wrong size on APreviewGeometryActor");
...
static_assert(sizeof(UTriangleSetComponent) == 0x000740, "Wrong size on UTriangleSetComponent");
static_assert(offsetof(UTriangleSetComponent, Bounds) == 0x000640, "Member 'UTriangleSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UTriangleSetComponent, bBoundsDirty) == 0x000678, "Member 'UTriangleSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(sizeof(APreviewMeshActor) == 0x0003B0, "Wrong size on APreviewMeshActor");
