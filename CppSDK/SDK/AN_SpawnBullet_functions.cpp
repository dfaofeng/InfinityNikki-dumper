...
#include "AN_SpawnBullet_classes.hpp"
#include "AN_SpawnBullet_parameters.hpp"
...
bool UAN_SpawnBullet_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, const struct FAnimNotifyEventReference& EventReference) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AN_SpawnBullet_C", "Received_Notify");

	Params::AN_SpawnBullet_C_Received_Notify Parms{};
