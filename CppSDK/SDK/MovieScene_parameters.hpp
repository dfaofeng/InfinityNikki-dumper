...
// Function MovieScene.MovieSceneSection.SetIsActive_Runtime
// 0x0001 (0x0001 - 0x0000)
struct MovieSceneSection_SetIsActive_Runtime final
{
public:
	bool                                          bInIsActive_Runtime;                               // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneSection_SetIsActive_Runtime) == 0x000001, "Wrong alignment on MovieSceneSection_SetIsActive_Runtime");
static_assert(sizeof(MovieSceneSection_SetIsActive_Runtime) == 0x000001, "Wrong size on MovieSceneSection_SetIsActive_Runtime");
static_assert(offsetof(MovieSceneSection_SetIsActive_Runtime, bInIsActive_Runtime) == 0x000000, "Member 'MovieSceneSection_SetIsActive_Runtime::bInIsActive_Runtime' has a wrong offset!");
...
// Function MovieScene.MovieSceneSection.GetNetPolicy
// 0x0001 (0x0001 - 0x0000)
struct MovieSceneSection_GetNetPolicy final
{
public:
	EMovieSceneNetPolicy                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneSection_GetNetPolicy) == 0x000001, "Wrong alignment on MovieSceneSection_GetNetPolicy");
static_assert(sizeof(MovieSceneSection_GetNetPolicy) == 0x000001, "Wrong size on MovieSceneSection_GetNetPolicy");
static_assert(offsetof(MovieSceneSection_GetNetPolicy, ReturnValue) == 0x000000, "Member 'MovieSceneSection_GetNetPolicy::ReturnValue' has a wrong offset!");
