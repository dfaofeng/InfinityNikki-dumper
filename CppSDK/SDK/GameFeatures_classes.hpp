...
static_assert(sizeof(UGameFeatureOptionalContentInstaller) == 0x000130, "Wrong size on UGameFeatureOptionalContentInstaller");
...
public:
	...
	uint8                                         Pad_100[0x118];                                    // 0x0100(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGameFeaturePluginStateMachine) == 0x000218, "Wrong size on UGameFeaturePluginStateMachine");
...
public:
	TSet<class FString> GetActivePluginNames() const;
	TArray<class FString> GetRegisteredPluginNames() const;
