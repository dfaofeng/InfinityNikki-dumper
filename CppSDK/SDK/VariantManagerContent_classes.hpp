...
public:
	...
	TMap<TSubclassOf<class UObject>, class ULevelVariantSetsFunctionDirector*> DirectorInstances;    // 0x03C8(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ALevelVariantSetsActor) == 0x000418, "Wrong size on ALevelVariantSetsActor");
...
static_assert(offsetof(ALevelVariantSetsActor, DirectorInstances) == 0x0003C8, "Member 'ALevelVariantSetsActor::DirectorInstances' has a wrong offset!");
...
public:
	...
	class USceneComponent*                        SceneComponent;                                    // 0x03C0(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         LastSelectedOption;                                // 0x03C8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ASwitchActor) == 0x0003D0, "Wrong size on ASwitchActor");
static_assert(offsetof(ASwitchActor, SceneComponent) == 0x0003C0, "Member 'ASwitchActor::SceneComponent' has a wrong offset!");
static_assert(offsetof(ASwitchActor, LastSelectedOption) == 0x0003C8, "Member 'ASwitchActor::LastSelectedOption' has a wrong offset!");
