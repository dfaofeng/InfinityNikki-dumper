...
#include "AN_SpawnEffectWind_classes.hpp"
#include "AN_SpawnEffectWind_parameters.hpp"
...
bool UAN_SpawnEffectWind_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, const struct FAnimNotifyEventReference& EventReference) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AN_SpawnEffectWind_C", "Received_Notify");

	Params::AN_SpawnEffectWind_C_Received_Notify Parms{};
