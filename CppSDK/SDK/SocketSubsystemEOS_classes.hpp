...
{
public:
	bool                                          bIsPassthrough;                                    // 0x0978(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsUsingP2PSockets;                                // 0x0979(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_97A[0x6];                                      // 0x097A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNetDriverEOSBase) == 0x000980, "Wrong size on UNetDriverEOSBase");
static_assert(offsetof(UNetDriverEOSBase, bIsPassthrough) == 0x000978, "Member 'UNetDriverEOSBase::bIsPassthrough' has a wrong offset!");
static_assert(offsetof(UNetDriverEOSBase, bIsUsingP2PSockets) == 0x000979, "Member 'UNetDriverEOSBase::bIsUsingP2PSockets' has a wrong offset!");
