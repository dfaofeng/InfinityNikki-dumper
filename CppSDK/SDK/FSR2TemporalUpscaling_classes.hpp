...
public:
	...
	EMaterialShadingModel                         ReactiveShadingModelID;                            // 0x007C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7D[0x3];                                       // 0x007D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ForceReactiveMaterialValue;                        // 0x0080(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ReactiveHistoryTranslucencyBias;                   // 0x0084(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ReactiveHistoryTranslucencyLumaBias;               // 0x0088(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UFSR2Settings, ReactiveShadingModelID) == 0x00007C, "Member 'UFSR2Settings::ReactiveShadingModelID' has a wrong offset!");
static_assert(offsetof(UFSR2Settings, ForceReactiveMaterialValue) == 0x000080, "Member 'UFSR2Settings::ForceReactiveMaterialValue' has a wrong offset!");
static_assert(offsetof(UFSR2Settings, ReactiveHistoryTranslucencyBias) == 0x000084, "Member 'UFSR2Settings::ReactiveHistoryTranslucencyBias' has a wrong offset!");
static_assert(offsetof(UFSR2Settings, ReactiveHistoryTranslucencyLumaBias) == 0x000088, "Member 'UFSR2Settings::ReactiveHistoryTranslucencyLumaBias' has a wrong offset!");
