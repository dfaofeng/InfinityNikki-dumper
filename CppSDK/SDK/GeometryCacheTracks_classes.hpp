...
{
public:
	struct FMovieSceneGeometryCacheParams         Params_0;                                          // 0x0120(0x0048)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneGeometryCacheSection) == 0x000168, "Wrong size on UMovieSceneGeometryCacheSection");
static_assert(offsetof(UMovieSceneGeometryCacheSection, Params_0) == 0x000120, "Member 'UMovieSceneGeometryCacheSection::Params_0' has a wrong offset!");
