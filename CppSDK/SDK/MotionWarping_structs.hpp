...
static_assert(alignof(FAttributeBasedRootMotionComponentPrePhysicsTickFunction) == 0x000008, "Wrong alignment on FAttributeBasedRootMotionComponentPrePhysicsTickFunction");
static_assert(sizeof(FAttributeBasedRootMotionComponentPrePhysicsTickFunction) == 0x000038, "Wrong size on FAttributeBasedRootMotionComponentPrePhysicsTickFunction");
...
public:
	...
	bool                                          bMirror;                                           // 0x001C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMotionWarpingUpdateContext) == 0x000004, "Wrong alignment on FMotionWarpingUpdateContext");
static_assert(sizeof(FMotionWarpingUpdateContext) == 0x000020, "Wrong size on FMotionWarpingUpdateContext");
...
static_assert(offsetof(FMotionWarpingUpdateContext, bMirror) == 0x00001C, "Member 'FMotionWarpingUpdateContext::bMirror' has a wrong offset!");
