...
void UNavigationSystemV1::RuntimeChangeRuntimeGenerationModeToDynamic(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NavigationSystemV1", "RuntimeChangeRuntimeGenerationModeToDynamic");

	Params::NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToDynamic Parms{};
...
void UNavigationSystemV1::RuntimeChangeRuntimeGenerationModeToStatic(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NavigationSystemV1", "RuntimeChangeRuntimeGenerationModeToStatic");

	Params::NavigationSystemV1_RuntimeChangeRuntimeGenerationModeToStatic Parms{};
