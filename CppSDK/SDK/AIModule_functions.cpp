...
// Parameters:
// const class FName&                      KeyName                                                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int64                                   IntValue                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBlackboardComponent::SetValueAsInt64(const class FName& KeyName, int64 IntValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BlackboardComponent", "SetValueAsInt64");

	Params::BlackboardComponent_SetValueAsInt64 Parms{};
...
int64 UBlackboardComponent::GetValueAsInt64(const class FName& KeyName) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BlackboardComponent", "GetValueAsInt64");

	Params::BlackboardComponent_GetValueAsInt64 Parms{};
...
void UBTFunctionLibrary::SetBlackboardValueAsInt64(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, int64 Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BTFunctionLibrary", "SetBlackboardValueAsInt64");

	Params::BTFunctionLibrary_SetBlackboardValueAsInt64 Parms{};
